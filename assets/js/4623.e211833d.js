"use strict";
(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[4623],{
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 23:
          this.$ = $$[$0];
    ...
    parseError: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function parse(input) {
      ...
      (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(Parser, "Parser");
...
var defaultThemeVariables = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getThemeVariables */ .P$)();
var QuadrantBuilder = class {
  ...
  static {
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "QuadrantBuilder");
  }
  getDefaultData() {
    return {
      titleText: "",
  ...
  getDefaultConfig() {
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.chartWidth || 500,
      chartWidth: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.chartHeight || 500,
      titlePadding: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.titlePadding || 10,
      titleFontSize: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.titleFontSize || 20,
      quadrantPadding: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantPadding || 5,
      xAxisLabelPadding: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisLabelPadding || 5,
      yAxisLabelPadding: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisLabelPadding || 5,
      xAxisLabelFontSize: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisLabelFontSize || 16,
      yAxisLabelFontSize: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisLabelFontSize || 16,
      quadrantLabelFontSize: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantLabelFontSize || 16,
      quadrantTextTopPadding: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantTextTopPadding || 5,
      pointTextPadding: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointTextPadding || 5,
      pointLabelFontSize: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointLabelFontSize || 12,
      pointRadius: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointRadius || 5,
      xAxisPosition: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisPosition || "top",
      yAxisPosition: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisPosition || "left",
      quadrantInternalBorderStrokeWidth: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
      quadrantExternalBorderStrokeWidth: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
    };
  }
  ...
  clear() {
    ...
    this.data = this.getDefaultData();
    this.classes = /* @__PURE__ */ new Map();
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.info("clear called");
  }
  setData(data) {
  ...
  setConfig(config2) {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.trace("setConfig called with: ", config2);
    this.config = { ...this.config, ...config2 };
  }
  setThemeConfig(themeConfig) {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.trace("setThemeConfig called with: ", themeConfig);
...
var InvalidStyleError = class extends Error {
  static {
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "InvalidStyleError");
  }
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(validateHexCode, "validateHexCode");
function validateNumber(value) {
  return !/^\d+$/.test(value);
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(validateNumber, "validateNumber");
function validateSizeInPixels(value) {
  return !/^\d+px$/.test(value);
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(validateSizeInPixels, "validateSizeInPixels");

// src/diagrams/quadrant-chart/quadrantDb.ts
var config = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
function textSanitizer(text) {
  return (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeText */ .jZ)(text.trim(), config);
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(textSanitizer, "textSanitizer");
var quadrantBuilder = new QuadrantBuilder();
function setQuadrant1Text(textObj) {
  quadrantBuilder.setData({ quadrant1Text: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant1Text, "setQuadrant1Text");
function setQuadrant2Text(textObj) {
  quadrantBuilder.setData({ quadrant2Text: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant2Text, "setQuadrant2Text");
function setQuadrant3Text(textObj) {
  quadrantBuilder.setData({ quadrant3Text: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant3Text, "setQuadrant3Text");
function setQuadrant4Text(textObj) {
  quadrantBuilder.setData({ quadrant4Text: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant4Text, "setQuadrant4Text");
function setXAxisLeftText(textObj) {
  quadrantBuilder.setData({ xAxisLeftText: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setXAxisLeftText, "setXAxisLeftText");
function setXAxisRightText(textObj) {
  quadrantBuilder.setData({ xAxisRightText: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setXAxisRightText, "setXAxisRightText");
function setYAxisTopText(textObj) {
  quadrantBuilder.setData({ yAxisTopText: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setYAxisTopText, "setYAxisTopText");
function setYAxisBottomText(textObj) {
  quadrantBuilder.setData({ yAxisBottomText: textSanitizer(textObj.text) });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setYAxisBottomText, "setYAxisBottomText");
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(parseStyles, "parseStyles");
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(addPoint, "addPoint");
function addClass(className, styles) {
  quadrantBuilder.addClass(className, parseStyles(styles));
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(addClass, "addClass");
function setWidth(width) {
  quadrantBuilder.setConfig({ chartWidth: width });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setWidth, "setWidth");
function setHeight(height) {
  quadrantBuilder.setConfig({ chartHeight: height });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setHeight, "setHeight");
function getQuadrantData() {
  const config2 = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  ...
  quadrantBuilder.setData({ titleText: (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .ab)() });
  return quadrantBuilder.build();
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getQuadrantData, "getQuadrantData");
var clear2 = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
  quadrantBuilder.clear();
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear */ .IU)();
}, "clear");
var quadrantDb_default = {
  ...
  getQuadrantData,
  clear: clear2,
  setAccTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setAccTitle */ .SV,
  getAccTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getAccTitle */ .iN,
  setDiagramTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setDiagramTitle */ .ke,
  getDiagramTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .ab,
  getAccDescription: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getAccDescription */ .m7,
  setAccDescription: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setAccDescription */ .EI
};

// src/diagrams/quadrant-chart/quadrantRenderer.ts

var draw = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((txt, id, _version, diagObj) => {
  function getDominantBaseLine(horizontalPos) {
    return horizontalPos === "top" ? "hanging" : "middle";
  }
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getDominantBaseLine, "getDominantBaseLine");
  function getTextAnchor(verticalPos) {
    return verticalPos === "left" ? "start" : "middle";
  }
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getTextAnchor, "getTextAnchor");
  function getTransformation(data) {
    return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
  }
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getTransformation, "getTransformation");
  const conf = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.debug("Rendering quadrant chart\n" + txt);
  ...
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .a$)(svg, height, width, conf.quadrantChart?.useMaxWidth ?? true);
...
var diagram = {
  ...
  styles: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => "", "styles")
};
