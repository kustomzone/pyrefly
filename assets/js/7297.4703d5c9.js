"use strict";
(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[7297],{
...
var ClassMember = class {
  static {
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "ClassMember");
  }
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .sanitizeText */ .jZ)(input, (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.returnType);
      }
    }
  ...
  parseMember(input) {
    ...
    const combinedText = `${this.visibility ? "\\" + this.visibility : ""}${(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.id)}${this.memberType === "method" ? `(${(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.parameters)})${this.returnType ? " : " + (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.returnType) : ""}` : ""}`;
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((txt) => _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(txt, (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((element) => {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().class, "getConfig");
  ...
  static {
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "ClassDB");
  }
  splitClassNameAndType(_id) {
    const id = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(className, (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  ...
  addRelation(classRelation) {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("Adding relation: " + JSON.stringify(classRelation));
    const invalidTypes = [
    ...
    classRelation.relationTitle1 = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()
    );
    classRelation.relationTitle2 = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    ...
    ids.split(",").forEach((_id) => {
      ...
      if (theClass) {
        theClass.link = _chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_domId, (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
    const config = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getEdgeId */ .rY)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var getStyles = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((options) => `g.classGroup text {
...
var getDir = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var draw = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Drawing class diagram (v3)", id);
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_SSJB2B2L_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  ...
  (0,_chunk_2O5F6CEG_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .P)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
