"use strict";
(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[8440],{
...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */ .K2)(() => (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getConfig2 */ .D7)().requirement, "getConfig");
    this.clear();
  ...
  static {
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */ .K2)(this, "RequirementDB");
  }
  getDirection() {
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .Rm.info("Added new element: ", name);
    }
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__export */ .VA)(requirementRenderer_exports, {
  draw: () => draw
});
var draw = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .Rm.info("Drawing requirement diagram (unified)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getConfig2 */ .D7)();
  ...
  (0,_chunk_2O5F6CEG_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .P)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
