"use strict";
(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[2846],{
...
/* harmony export */ });
/* harmony import */ var _chunk_IUKPXING_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(80902);
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.gitGraph;
var getConfig3 = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  const config = (0,_chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)({
    ...DEFAULT_GITGRAPH_CONFIG,
    ...(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)().gitGraph
  });
  return config;
}, "getConfig");
var state = new _chunk_66XRIAFR_mjs__WEBPACK_IMPORTED_MODULE_1__/* .ImperativeState */ .m(() => {
...
function getID() {
  return (0,_chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .random */ .yT)({ length: 7 });
}
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getID, "getID");
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(uniqBy, "uniqBy");
var setDirection = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(dir2) {
  state.records.direction = dir2;
}, "setDirection");
var setOptions = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(rawOptString) {
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("options str", rawOptString);
  rawOptString = rawOptString?.trim();
  rawOptString = rawOptString || "{}";
  try {
    state.records.options = JSON.parse(rawOptString);
  } catch (e) {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.error("error while parsing gitGraph options", e.message);
  }
}, "setOptions");
var getOptions = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return state.records.options;
}, "getOptions");
var commit = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(commitDB) {
  let msg = commitDB.msg;
  let id = commitDB.id;
  const type = commitDB.type;
  let tags = commitDB.tags;
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("commit", msg, id, type, tags);
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("Entering commit:", msg, id, type, tags);
  const config = getConfig3();
  id = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(id, config);
  msg = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  const newCommit = {
  ...
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("main branch", config.mainBranchName);
  state.records.commits.set(newCommit.id, newCommit);
  state.records.branches.set(state.records.currBranch, newCommit.id);
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("in pushCommit " + newCommit.id);
}, "commit");
var branch = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(branchDB) {
  let name = branchDB.name;
  const order = branchDB.order;
  name = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(name, getConfig3());
  ...
  checkout(name);
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("in createBranch");
}, "branch");
var merge = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((mergeDB) => {
  let otherBranch = mergeDB.branch;
  let customId = mergeDB.id;
  const overrideType = mergeDB.type;
  const customTags = mergeDB.tags;
  const config = getConfig3();
  otherBranch = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(customId, config);
  }
  ...
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(state.records.branches);
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("in mergeBranch");
}, "merge");
var cherryPick = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(cherryPickDB) {
  let sourceId = cherryPickDB.id;
  let targetId = cherryPickDB.targetId;
  let tags = cherryPickDB.tags;
  let parentCommitId = cherryPickDB.parent;
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("Entering cherryPick:", sourceId, targetId, tags);
  const config = getConfig3();
  sourceId = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(sourceId, config);
  targetId = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  parentCommitId = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(parentCommitId, config);
  ...
  if (!targetId || !state.records.commits.has(targetId)) {
    ...
    state.records.branches.set(state.records.currBranch, commit2.id);
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(state.records.branches);
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("in cherryPick");
  }
}, "cherryPick");
var checkout = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(branch2) {
  branch2 = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(branch2, getConfig3());
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(upsert, "upsert");
function prettyPrintCommitHistory(commitArr) {
  ...
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(label.join(" "));
...
(0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(prettyPrintCommitHistory, "prettyPrintCommitHistory");
var prettyPrint = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(state.records.commits);
  const node = getCommitsArray()[0];
  prettyPrintCommitHistory([node]);
}, "prettyPrint");
var clear2 = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  state.reset();
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .clear */ .IU)();
}, "clear");
var getBranchesAsObjArray = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
...
var getBranches = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return state.records.branches;
}, "getBranches");
var getCommits = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return state.records.commits;
}, "getCommits");
var getCommitsArray = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  const commitArr = [...state.records.commits.values()];
  commitArr.forEach(function(o) {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(o.id);
  });
  commitArr.sort((a, b) => a.seq - b.seq);
  return commitArr;
}, "getCommitsArray");
var getCurrentBranch = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return state.records.currBranch;
}, "getCurrentBranch");
var getDirection = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return state.records.direction;
}, "getDirection");
var getHead = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
...
var db = {
  ...
  getDirection,
  getHead,
  setAccTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setAccTitle */ .SV,
  getAccTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getAccTitle */ .iN,
  getAccDescription: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getAccDescription */ .m7,
  setAccDescription: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setAccDescription */ .EI,
  setDiagramTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setDiagramTitle */ .ke,
  getDiagramTitle: _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab
};

// src/diagrams/git/gitGraphParser.ts
var populate = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((ast, db2) => {
  (0,_chunk_IUKPXING_mjs__WEBPACK_IMPORTED_MODULE_0__/* .populateCommonDb */ .S)(ast, db2);
  if (ast.dir) {
...
var parseStatement = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((statement, db2) => {
  const parsers = {
    Commit: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((stmt) => db2.commit(parseCommit(stmt)), "Commit"),
    Branch: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((stmt) => db2.branch(parseBranch(stmt)), "Branch"),
    Merge: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((stmt) => db2.merge(parseMerge(stmt)), "Merge"),
    Checkout: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((stmt) => db2.checkout(parseCheckout(stmt)), "Checkout"),
    CherryPicking: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((stmt) => db2.cherryPick(parseCherryPicking(stmt)), "CherryPicking")
  };
  const parser2 = parsers[statement.$type];
  if (parser2) {
    parser2(statement);
  } else {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.error(`Unknown statement type: ${statement.$type}`);
  }
}, "parseStatement");
var parseCommit = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2) => {
  const commitDB = {
    id: commit2.id,
    msg: commit2.message ?? "",
...
var parseBranch = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((branch2) => {
  const branchDB = {
    name: branch2.name,
...
var parseMerge = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((merge2) => {
  const mergeDB = {
...
var parseCheckout = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((checkout2) => {
  const branch2 = checkout2.branch;
  return branch2;
}, "parseCheckout");
var parseCherryPicking = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((cherryPicking) => {
  const cherryPickDB = {
    id: cherryPicking.id,
    targetId: "",
...
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async (input) => {
    const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_4__/* .parse */ .qg)("gitGraph", input);
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(ast);
    populate(ast, db);
  }, "parse")
};
if (void 0) {
...
var DEFAULT_CONFIG = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var maxPos = 0;
var dir = "LR";
var clear3 = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  branchPos.clear();
  commitPos.clear();
...
var drawText = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((txt) => {
...
var findClosestParent = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parents) => {
  let closestParent;
  let comparisonFunc;
  let targetPosition;
  if (dir === "BT") {
    comparisonFunc = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((a, b) => a <= b, "comparisonFunc");
...
var findClosestParentBT = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parents) => {
  let closestParent = "";
...
var setParallelBTPos = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((sortedKeys, commits, defaultPos2) => {
...
var findClosestParentPos = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2) => {
...
var calculateCommitPosition = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2) => {
  const closestParentPos = findClosestParentPos(commit2);
  return closestParentPos + COMMIT_STEP;
}, "calculateCommitPosition");
var setCommitPosition = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2, curPos) => {
...
var setRootPosition = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2, curPos, defaultPos2) => {
  const branch2 = branchPos.get(commit2.branch);
  if (!branch2) {
    throw new Error(`Branch not found for commit ${commit2.id}`);
  }
...
var drawCommitBullet = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
...
var drawCommitLabel = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((gLabels, commit2, commitPosition, pos) => {
...
var drawCommitTags = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((gLabels, commit2, commitPosition, pos) => {
...
var getCommitClassType = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2) => {
...
var calculatePosition = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2, dir2, pos, commitPos2) => {
...
var getCommitPosition = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commit2, pos, isParallelCommits) => {
...
var drawCommits = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, commits, modifyGraph) => {
  ...
  const sortKeys = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((a, b) => {
...
var shouldRerouteArrow = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((commitA, commitB, p1, p2, allCommits) => {
  const commitBIsFurthest = dir === "TB" || dir === "BT" ? p1.x < p2.x : p1.y < p2.y;
  const branchToGetCurve = commitBIsFurthest ? commitB.branch : commitA.branch;
  const isOnBranchToGetCurve = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((x) => x.branch === branchToGetCurve, "isOnBranchToGetCurve");
  const isBetweenCommits = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((x) => x.seq > commitA.seq && x.seq < commitB.seq, "isBetweenCommits");
  return [...allCommits.values()].some((commitX) => {
    return isBetweenCommits(commitX) && isOnBranchToGetCurve(commitX);
  });
}, "shouldRerouteArrow");
var findLane = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((y1, y2, depth = 0) => {
...
var drawArrow = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, commitA, commitB, allCommits) => {
...
var drawArrows = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, commits) => {
...
var drawBranches = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, branches) => {
...
var setBranchPosition = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(name, pos, index, bbox, rotateCommitLabel) {
  branchPos.set(name, { pos, index });
  pos += 50 + (rotateCommitLabel ? 40 : 0) + (dir === "TB" || dir === "BT" ? bbox.width / 2 : 0);
  return pos;
}, "setBranchPosition");
var draw = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(txt, id, ver, diagObj) {
  clear3();
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  if (!DEFAULT_GITGRAPH_CONFIG2) {
    throw new Error("GitGraph config not found");
  }
  ...
  _chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.insertTitle(
    diagram2,
    "gitTitleText",
    DEFAULT_GITGRAPH_CONFIG2.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupGraphViewbox2 */ .mj)(
    void 0,
    diagram2,
...
if (void 0) {
  ...
  describe("branchPosition", () => {
    const bbox = {
      ...
      bottom: 0,
      left: 0,
      toJSON: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => "", "toJSON")
    };
...
var getStyles = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((options) => `
  .commit-id,
  .commit-msg,
  .branch-label {
    fill: lightgrey;
