(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[8792],{
...
/* harmony export */ });
const ThemeClassNames={page:{blogListPage:'blog-list-page',blogPostPage:'blog-post-page',blogTagsListPage:'blog-tags-list-page',blogTagPostListPage:'blog-tags-post-list-page',blogAuthorsListPage:'blog-authors-list-page',blogAuthorsPostsPage:'blog-authors-posts-page',docsDocPage:'docs-doc-page',docsTagsListPage:'docs-tags-list-page',docsTagDocListPage:'docs-tags-doc-list-page',mdxPage:'mdx-page'},wrapper:{main:'main-wrapper',blogPages:'blog-wrapper',docsPages:'docs-wrapper',mdxPages:'mdx-wrapper'},common:{editThisPage:'theme-edit-this-page',lastUpdated:'theme-last-updated',backToTopButton:'theme-back-to-top-button',codeBlock:'theme-code-block',admonition:'theme-admonition',unlistedBanner:'theme-unlisted-banner',draftBanner:'theme-draft-banner',admonitionType:type=>`theme-admonition-${type}`},layout:{},docs:{docVersionBanner:'theme-doc-version-banner',docVersionBadge:'theme-doc-version-badge',docBreadcrumbs:'theme-doc-breadcrumbs',docMarkdown:'theme-doc-markdown',docTocMobile:'theme-doc-toc-mobile',docTocDesktop:'theme-doc-toc-desktop',docFooter:'theme-doc-footer',docFooterTagsRow:'theme-doc-footer-tags-row',docFooterEditMetaRow:'theme-doc-footer-edit-meta-row',docSidebarContainer:'theme-doc-sidebar-container',docSidebarMenu:'theme-doc-sidebar-menu',docSidebarItemCategory:'theme-doc-sidebar-item-category',docSidebarItemLink:'theme-doc-sidebar-item-link',docSidebarItemCategoryLevel:level=>`theme-doc-sidebar-item-category-level-${level}`,docSidebarItemLinkLevel:level=>`theme-doc-sidebar-item-link-level-${level}`},blog:{blogFooterTagsRow:'theme-blog-footer-tags-row',blogFooterEditMetaRow:'theme-blog-footer-edit-meta-row'},pages:{pageFooterEditMetaRow:'theme-pages-footer-edit-meta-row'}};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Meta Platforms, Inc. Built with Docusaurus."
    },
    "docs": {
  ...
  "presets": [
    [
      "/home/runner/work/pyrefly/pyrefly/website/node_modules/docusaurus-plugin-internaldocs-fb/docusaurus-preset.js",
      {
        "docs": {
          "routeBasePath": "en/docs",
          "sidebarPath": false,
          "editUrl": "https://github.com/facebook/pyrefly/edit/main/website/",
          "remarkPlugins": [
            [
              null,
              {
        ...
        "theme": {
          "customCss": "/home/runner/work/pyrefly/pyrefly/website/src/css/custom.css"
        },
        "enableEditor": true,
        "gtag": {
          "trackingID": "G-GSX14JC495",
          "anonymizeIP": true
        }
      }
    ]
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Redirect: () => (/* reexport safe */ react_router_dom__WEBPACK_IMPORTED_MODULE_0__.rd),
/* harmony export */   matchPath: () => (/* reexport safe */ react_router_dom__WEBPACK_IMPORTED_MODULE_0__.B6),
/* harmony export */   useHistory: () => (/* reexport safe */ react_router_dom__WEBPACK_IMPORTED_MODULE_0__.W6),
/* harmony export */   useLocation: () => (/* reexport safe */ react_router_dom__WEBPACK_IMPORTED_MODULE_0__.zy)
/* harmony export */ });
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56347);
...
function Heading(_ref){let{as:As,id,...props}=_ref;const brokenLinks=(0,useBrokenLinks/* default */.A)();const{navbar:{hideOnScroll}}=(0,useThemeConfig/* useThemeConfig */.p)();if(As==='h1'||!id){return/*#__PURE__*/(0,jsx_runtime.jsx)(As,{...props,id:undefined});}brokenLinks.collectAnchor(id);const anchorTitle=(0,Translate.translate)({id:'theme.common.headingLinkTitle',message:'Direct link to {heading}',description:'Title for link to heading'},{heading:typeof props.children==='string'?props.children:id});return/*#__PURE__*/(0,jsx_runtime.jsxs)(As,{...props,className:(0,clsx/* default */.A)('anchor',hideOnScroll?styles_module.anchorWithHideOnScrollNavbar:styles_module.anchorWithStickyNavbar,props.className),id:id,children:[props.children,/*#__PURE__*/(0,jsx_runtime.jsx)(Link["default"],{className:"hash-link",to:`#${id}`,"aria-label":anchorTitle,title:anchorTitle,children:"\u200B"})]});}
...
"use strict";
var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{"default":mod};};Object.defineProperty(exports, "__esModule", ({value:true}));const hogan_js_1=__importDefault(__webpack_require__(34714));const lunar_search_1=__importDefault(__webpack_require__(98541));const autocomplete_js_1=__importDefault(__webpack_require__(64498));const templates_1=__importDefault(__webpack_require__(86739));const utils_1=__importDefault(__webpack_require__(50357));const zepto_1=__importDefault(__webpack_require__(53704));class DocSearch{constructor(_ref){let{searchDocs,searchIndex,inputSelector,debug=false,baseUrl='/',queryDataCallback=null,autocompleteOptions={debug:false,hint:false,autoselect:true},transformData=false,queryHook=false,handleSelected=false,enhancedSearchInput=false,layout="collumns"}=_ref;this.input=DocSearch.getInputFromSelector(inputSelector);this.queryDataCallback=queryDataCallback||null;const autocompleteOptionsDebug=autocompleteOptions&&autocompleteOptions.debug?autocompleteOptions.debug:false;autocompleteOptions.debug=debug||autocompleteOptionsDebug;this.autocompleteOptions=autocompleteOptions;this.autocompleteOptions.cssClasses=this.autocompleteOptions.cssClasses||{};this.autocompleteOptions.cssClasses.prefix=this.autocompleteOptions.cssClasses.prefix||"ds";const inputAriaLabel=this.input&&typeof this.input.attr==="function"&&this.input.attr("aria-label");this.autocompleteOptions.ariaLabel=this.autocompleteOptions.ariaLabel||inputAriaLabel||"search input";this.isSimpleLayout=layout==="simple";this.client=new lunar_search_1.default(searchDocs,searchIndex,baseUrl);if(enhancedSearchInput){this.input=DocSearch.injectSearchBox(this.input);}this.autocomplete=(0,autocomplete_js_1.default)(this.input,autocompleteOptions,[{source:this.getAutocompleteSource(transformData,queryHook),templates:{suggestion:DocSearch.getSuggestionTemplate(this.isSimpleLayout),footer:templates_1.default.footer,empty:DocSearch.getEmptyTemplate()}}]);const customHandleSelected=handleSelected;this.handleSelected=customHandleSelected||this.handleSelected;if(customHandleSelected){(0,zepto_1.default)(".algolia-autocomplete").on("click",".ds-suggestions a",event=>{event.preventDefault();});}this.autocomplete.on("autocomplete:selected",this.handleSelected.bind(null,this.autocomplete.autocomplete));this.autocomplete.on("autocomplete:shown",this.handleShown.bind(null,this.input));if(enhancedSearchInput){DocSearch.bindSearchBoxEvent();}}static injectSearchBox(input){input.before(templates_1.default.searchBox);const newInput=input.prev().prev().find("input");input.remove();return newInput;}static bindSearchBoxEvent(){(0,zepto_1.default)('.searchbox [type="reset"]').on("click",function(){(0,zepto_1.default)("input#docsearch").focus();(0,zepto_1.default)(this).addClass("hide");autocomplete_js_1.default.autocomplete.setVal("");});(0,zepto_1.default)("input#docsearch").on("keyup",()=>{const searchbox=document.querySelector("input#docsearch");const reset=document.querySelector('.searchbox [type="reset"]');reset.className="searchbox__reset";if(searchbox.value.length===0){reset.className+=" hide";}});}static getInputFromSelector(selector){const input=(0,zepto_1.default)(selector).filter("input");return input.length?(0,zepto_1.default)(input[0]):null;}getAutocompleteSource(transformData,queryHook){return(query,callback)=>{if(queryHook){query=queryHook(query)||query;}this.client.search(query).then(hits=>{if(this.queryDataCallback&&typeof this.queryDataCallback=="function"){this.queryDataCallback(hits);}if(transformData){hits=transformData(hits)||hits;}callback(DocSearch.formatHits(hits));});};}static formatHits(receivedHits){const clonedHits=utils_1.default.deepClone(receivedHits);const hits=clonedHits.map(hit=>{if(hit._highlightResult){hit._highlightResult=utils_1.default.mergeKeyWithParent(hit._highlightResult,"hierarchy");}return utils_1.default.mergeKeyWithParent(hit,"hierarchy");});let groupedHits=utils_1.default.groupBy(hits,"lvl0");zepto_1.default.each(groupedHits,(level,collection)=>{const groupedHitsByLvl1=utils_1.default.groupBy(collection,"lvl1");const flattenedHits=utils_1.default.flattenAndFlagFirst(groupedHitsByLvl1,"isSubCategoryHeader");groupedHits[level]=flattenedHits;});groupedHits=utils_1.default.flattenAndFlagFirst(groupedHits,"isCategoryHeader");return groupedHits.map(hit=>{const url=DocSearch.formatURL(hit);const category=utils_1.default.getHighlightedValue(hit,"lvl0");const subcategory=utils_1.default.getHighlightedValue(hit,"lvl1")||category;const displayTitle=utils_1.default.compact([utils_1.default.getHighlightedValue(hit,"lvl2")||subcategory,utils_1.default.getHighlightedValue(hit,"lvl3"),utils_1.default.getHighlightedValue(hit,"lvl4"),utils_1.default.getHighlightedValue(hit,"lvl5"),utils_1.default.getHighlightedValue(hit,"lvl6")]).join('<span class="aa-suggestion-title-separator" aria-hidden="true"> › </span>');const text=utils_1.default.getSnippetedValue(hit,"content");const isTextOrSubcategoryNonEmpty=subcategory&&subcategory!==""||displayTitle&&displayTitle!=="";const isLvl1EmptyOrDuplicate=!subcategory||subcategory===""||subcategory===category;const isLvl2=displayTitle&&displayTitle!==""&&displayTitle!==subcategory;const isLvl1=!isLvl2&&subcategory&&subcategory!==""&&subcategory!==category;const isLvl0=!isLvl1&&!isLvl2;return{isLvl0,isLvl1,isLvl2,isLvl1EmptyOrDuplicate,isCategoryHeader:hit.isCategoryHeader,isSubCategoryHeader:hit.isSubCategoryHeader,isTextOrSubcategoryNonEmpty,category,subcategory,title:displayTitle,text,url};});}static formatURL(hit){const{url,anchor}=hit;if(url){const containsAnchor=url.indexOf("#")!==-1;if(containsAnchor)return url;else if(anchor)return`${hit.url}#${hit.anchor}`;return url;}else if(anchor)return`#${hit.anchor}`;console.warn("no anchor nor url for : ",JSON.stringify(hit));return null;}static getEmptyTemplate(){return args=>hogan_js_1.default.compile(templates_1.default.empty).render(args);}static getSuggestionTemplate(isSimpleLayout){const stringTemplate=isSimpleLayout?templates_1.default.suggestionSimple:templates_1.default.suggestion;const template=hogan_js_1.default.compile(stringTemplate);return suggestion=>template.render(suggestion);}handleSelected(input,event,suggestion,datasetNumber,context){if(context===void 0){context={};}if(context.selectionMethod==="click"){return;}input.setVal("");window.location.assign(suggestion.url);}handleShown(input){const middleOfInput=input.offset().left+input.width()/2;let middleOfWindow=(0,zepto_1.default)(document).width()/2;if(isNaN(middleOfWindow)){middleOfWindow=900;}const alignClass=middleOfInput-middleOfWindow>=0?"algolia-autocomplete-right":"algolia-autocomplete-left";const otherAlignClass=middleOfInput-middleOfWindow<0?"algolia-autocomplete-right":"algolia-autocomplete-left";const autocompleteWrapper=(0,zepto_1.default)(".algolia-autocomplete");if(!autocompleteWrapper.hasClass(alignClass)){autocompleteWrapper.addClass(alignClass);}if(autocompleteWrapper.hasClass(otherAlignClass)){autocompleteWrapper.removeClass(otherAlignClass);}}}exports["default"]=DocSearch;
...
/* harmony export */ });
function duplicates(arr,comparator){if(comparator===void 0){comparator=(a,b)=>a===b;}return arr.filter((v,vIndex)=>arr.findIndex(u=>comparator(u,v))!==vIndex);}function uniq(arr){return Array.from(new Set(arr));}function groupBy(items,keySelector){const result={};let index=0;for(const item of items){const key=keySelector(item,index);result[key]??=[];result[key].push(item);index+=1;}return result;}
...
/* harmony import */ var _theme_ThemedImage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(24475);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74848);
function LogoThemedImage(_ref){let{logo,alt,imageClassName}=_ref;const sources={light:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__["default"])(logo.src),dark:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__["default"])(logo.srcDark||logo.src)};const themedImage=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_theme_ThemedImage__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A,{className:logo.className,sources:sources,height:logo.height,width:logo.width,alt:alt,style:logo.style});return imageClassName?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div",{className:imageClassName,children:themedImage}):themedImage;}function Logo(props){const{siteConfig:{title}}=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_3__["default"])();const{navbar:{title:navbarTitle,logo}}=(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_6__/* .useThemeConfig */ .p)();const{imageClassName,titleClassName,...propsRest}=props;const logoLink=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__["default"])(logo?.href||'/');const fallbackAlt=navbarTitle?'':title;const alt=logo?.alt??fallbackAlt;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__["default"],{to:logoLink,...propsRest,...(logo?.target&&{target:logo.target}),children:[logo&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(LogoThemedImage,{logo:logo,alt:alt,imageClassName:imageClassName}),navbarTitle!=null&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("b",{className:titleClassName,children:navbarTitle})]});}
...
/* harmony export */ });
const isTree=x=>typeof x==='object'&&!!x&&Object.keys(x).length>0;function flat(target){const delimiter='.';const output={};function dfs(object,prefix){Object.entries(object).forEach(_ref=>{let[key,value]=_ref;const newKey=prefix?`${prefix}${delimiter}${key}`:key;if(isTree(value)){dfs(value,newKey);}else{output[newKey]=value;}});}dfs(target);return output;}
...
/* harmony import */ var _useLocationChange__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(77685);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74848);
const SkipToContentFallbackId='__docusaurus_skipToContent_fallback';function getSkipToContentTarget(){return document.querySelector('main:first-of-type')??document.getElementById(SkipToContentFallbackId);}function programmaticFocus(el){el.setAttribute('tabindex','-1');el.focus();el.removeAttribute('tabindex');}function useSkipToContent(){const containerRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);const{action}=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_3__/* .useHistory */ .W6)();const onClick=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(e=>{e.preventDefault();const targetElement=getSkipToContentTarget();if(targetElement){programmaticFocus(targetElement);}},[]);(0,_useLocationChange__WEBPACK_IMPORTED_MODULE_4__/* .useLocationChange */ .$)(_ref=>{let{location}=_ref;if(containerRef.current&&!location.hash&&action==='PUSH'){programmaticFocus(containerRef.current);}});return{containerRef,onClick};}const DefaultSkipToContentLabel=(0,_docusaurus_Translate__WEBPACK_IMPORTED_MODULE_1__.translate)({id:'theme.common.skipToMainContent',description:'The skip to content label used for accessibility, allowing to rapidly navigate to main content with keyboard tab/enter navigation',message:'Skip to main content'});function SkipToContentLink(props){const linkLabel=props.children??DefaultSkipToContentLabel;const{containerRef,onClick}=useSkipToContent();return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div",{ref:containerRef,role:"region","aria-label":DefaultSkipToContentLabel,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("a",{...props,href:`#${SkipToContentFallbackId}`,onClick:onClick,children:linkLabel})});}
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74848);
const Context=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(null);function DocsVersionProvider(_ref){let{children,version}=_ref;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Context.Provider,{value:version,children:children});}function useDocsVersion(){const version=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(version===null){throw new _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_2__/* .ReactContextError */ .dV('DocsVersionProvider');}return version;}
...
/* harmony import */ var _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26849);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74848);
const EmptyContext=Symbol('EmptyContext');const Context=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(EmptyContext);function DocsSidebarProvider(_ref){let{children,name,items}=_ref;const stableValue=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>name&&items?{name,items}:null,[name,items]);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Context.Provider,{value:stableValue,children:children});}function useDocsSidebar(){const value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(value===EmptyContext){throw new _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_2__/* .ReactContextError */ .dV('DocsSidebarProvider');}return value;}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.getSpecInfo=void 0;const bridge_1=__webpack_require__(67826);function getSpecInfo(styleId){return(0,bridge_1.call)({module:'bloks',api:'getSpecInfo',args:{styleId}});}exports.getSpecInfo=getSpecInfo;
...
/* harmony export */ });
/* harmony import */ var _docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(69493);
/* harmony import */ var _docsPreferredVersion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96351);
function getDocsVersionSearchTag(pluginId,versionName){return`docs-${pluginId}-${versionName}`;}function useDocsContextualSearchTags(){const allDocsData=(0,_docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_0__/* .useAllDocsData */ .Gy)();const activePluginAndVersion=(0,_docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_0__/* .useActivePluginAndVersion */ .gk)();const docsPreferredVersionByPluginId=(0,_docsPreferredVersion__WEBPACK_IMPORTED_MODULE_1__/* .useDocsPreferredVersionByPluginId */ .XK)();function getDocPluginTags(pluginId){const activeVersion=activePluginAndVersion?.activePlugin.pluginId===pluginId?activePluginAndVersion.activeVersion:undefined;const preferredVersion=docsPreferredVersionByPluginId[pluginId];const latestVersion=allDocsData[pluginId].versions.find(v=>v.isLast);const version=activeVersion??preferredVersion??latestVersion;return getDocsVersionSearchTag(pluginId,version.name);}return[...Object.keys(allDocsData).map(getDocPluginTags)];}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.reportContentSelected=exports.reportFeatureUsage=exports.reportContentCopied=void 0;const bridge_1=__webpack_require__(67826);const noop=()=>{};function reportContentCopied(args){const{textContent}=args;return(0,bridge_1.call)({module:'feedback',api:'reportContentCopied',args:{textContent}}).then(noop).catch(noop);}exports.reportContentCopied=reportContentCopied;function reportFeatureUsage(args){const{featureName,id}=args;console.log('used feature');return(0,bridge_1.call)({module:'feedback',api:'reportFeatureUsage',args:{featureName,id}}).then(noop).catch(noop);}exports.reportFeatureUsage=reportFeatureUsage;function reportContentSelected(args){const{textContent}=args;return(0,bridge_1.call)({module:'feedback',api:'reportContentSelected',args:{textContent}}).then(noop).catch(noop);}exports.reportContentSelected=reportContentSelected;
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68283);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74848);
function ThemedImage(props){const{sources,className:parentClassName,alt,...propsRest}=props;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{className:parentClassName,children:_ref=>{let{theme,className}=_ref;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("img",{src:sources[theme],alt:alt,className:className,...propsRest});}});}
...
const createStatefulBrokenLinks=()=>{const allAnchors=new Set();const allLinks=new Set();return{collectAnchor:anchor=>{typeof anchor!=='undefined'&&allAnchors.add(anchor);},collectLink:link=>{typeof link!=='undefined'&&allLinks.add(link);},getCollectedAnchors:()=>[...allAnchors],getCollectedLinks:()=>[...allLinks]};};const Context=/*#__PURE__*/react.createContext({collectAnchor:()=>{},collectLink:()=>{}});const useBrokenLinksContext=()=>(0,react.useContext)(Context);function BrokenLinksProvider(_ref){let{children,brokenLinks}=_ref;return/*#__PURE__*/_jsx(Context.Provider,{value:brokenLinks,children:children});}
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74848);
function useEvent(callback){const ref=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(callback);(0,_docusaurus_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(()=>{ref.current=callback;},[callback]);return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function(){return ref.current(...arguments);},[]);}function usePrevious(value){const ref=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();(0,_docusaurus_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(()=>{ref.current=value;});return ref.current;}class ReactContextError extends Error{constructor(providerName,additionalInfo){super();this.name='ReactContextError';this.message=`Hook ${this.stack?.split('\n')[1]?.match(/at (?:\w+\.)?(?<name>\w+)/)?.groups.name??''} is called outside the <${providerName}>. ${additionalInfo??''}`;}}function useShallowMemoObject(obj){const deps=Object.entries(obj);deps.sort((a,b)=>a[0].localeCompare(b[0]));return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>obj,deps.flat());}function composeProviders(providers){return _ref=>{let{children}=_ref;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.Fragment,{children:providers.reduceRight((element,CurrentProvider)=>/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(CurrentProvider,{children:element}),children)});};}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.addPrefix=addPrefix;exports.removeSuffix=removeSuffix;exports.addSuffix=addSuffix;exports.removePrefix=removePrefix;function addPrefix(str,prefix){return str.startsWith(prefix)?str:`${prefix}${str}`;}function removeSuffix(str,suffix){if(suffix===''){return str;}return str.endsWith(suffix)?str.slice(0,-suffix.length):str;}function addSuffix(str,suffix){return str.endsWith(suffix)?str:`${str}${suffix}`;}function removePrefix(str,prefix){return str.startsWith(prefix)?str.slice(prefix.length):str;}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addBaseUrl: () => (/* binding */ addBaseUrl),
...
function addBaseUrl(_ref){let{siteUrl,baseUrl,url,options:{forcePrependBaseUrl=false,absolute=false}={},router}=_ref;if(!url||url.startsWith('#')||(0,_isInternalUrl__WEBPACK_IMPORTED_MODULE_2__/* .hasProtocol */ .z)(url)){return url;}if(router==='hash'){return url.startsWith('/')?`.${url}`:`./${url}`;}if(forcePrependBaseUrl){return baseUrl+url.replace(/^\//,'');}if(url===baseUrl.replace(/\/$/,'')){return baseUrl;}const shouldAddBaseUrl=!url.startsWith(baseUrl);const basePath=shouldAddBaseUrl?baseUrl+url.replace(/^\//,''):url;return absolute?siteUrl+basePath:basePath;}function useBaseUrlUtils(){const{siteConfig}=(0,_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_1__["default"])();const{baseUrl,url:siteUrl}=siteConfig;const router=siteConfig.future.experimental_router;const withBaseUrl=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((url,options)=>addBaseUrl({siteUrl,baseUrl,url,options,router}),[siteUrl,baseUrl,router]);return{withBaseUrl};}function useBaseUrl(url,options){if(options===void 0){options={};}const{withBaseUrl}=useBaseUrlUtils();return withBaseUrl(url,options);}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const clientModule={onRouteDidUpdate(_ref){let{location,previousLocation}=_ref;if(previousLocation&&(location.pathname!==previousLocation.pathname||location.search!==previousLocation.search||location.hash!==previousLocation.hash)){setTimeout(()=>{window.gtag('set','page_path',location.pathname+location.search+location.hash);window.gtag('event','page_view');});}}};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clientModule);
...
function isSamePath(path1,path2){const normalize=pathname=>(!pathname||pathname.endsWith('/')?pathname:`${pathname}/`)?.toLowerCase();return normalize(path1)===normalize(path2);}function findHomePageRoute(_ref){let{baseUrl,routes:initialRoutes}=_ref;function isHomePageRoute(route){return route.path===baseUrl&&route.exact===true;}function isHomeParentRoute(route){return route.path===baseUrl&&!route.exact;}function doFindHomePageRoute(routes){if(routes.length===0){return undefined;}const homePage=routes.find(isHomePageRoute);if(homePage){return homePage;}const indexSubRoutes=routes.filter(isHomeParentRoute).flatMap(route=>route.routes??[]);return doFindHomePageRoute(indexSubRoutes);}return doFindHomePageRoute(initialRoutes);}function useHomePageRoute(){const{baseUrl}=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_2__["default"])().siteConfig;return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>findHomePageRoute({routes:_generated_routes__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,baseUrl}),[baseUrl]);}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.getServiceStatus=void 0;const bridge_1=__webpack_require__(67826);function getServiceStatus(){return(0,bridge_1.call)({module:'metagen',api:'getServiceStatus',args:{}});}exports.getServiceStatus=getServiceStatus;
...
/* harmony export */   W9: () => (/* binding */ useClearQueryString),
/* harmony export */   aZ: () => (/* binding */ useQueryStringValue),
/* harmony export */   fV: () => (/* binding */ useQueryStringList),
...
function useHistoryActionHandler(handler){const history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useHistory */ .W6)();const stableHandler=(0,_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .useEvent */ ._q)(handler);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>history.block((location,action)=>stableHandler(location,action)),[history,stableHandler]);}function useHistoryPopHandler(handler){useHistoryActionHandler((location,action)=>{if(action==='POP'){return handler(location,action);}return undefined;});}function useHistorySelector(selector){const history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useHistory */ .W6)();return (0,react__WEBPACK_IMPORTED_MODULE_0__.useSyncExternalStore)(history.listen,()=>selector(history),()=>selector(history));}function useQueryStringValue(key){return useHistorySelector(history=>{if(key===null){return null;}return new URLSearchParams(history.location.search).get(key);});}function useQueryStringUpdater(key){const history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useHistory */ .W6)();return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((newValue,options)=>{const searchParams=new URLSearchParams(history.location.search);if(newValue){searchParams.set(key,newValue);}else{searchParams.delete(key);}const updateHistory=options?.push?history.push:history.replace;updateHistory({search:searchParams.toString()});},[key,history]);}function useQueryString(key){const value=useQueryStringValue(key)??'';const update=useQueryStringUpdater(key);return[value,update];}function useQueryStringListValues(key){const arrayJsonString=useHistorySelector(history=>{const values=new URLSearchParams(history.location.search).getAll(key);return JSON.stringify(values);});return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>JSON.parse(arrayJsonString),[arrayJsonString]);}function useQueryStringListUpdater(key){const history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useHistory */ .W6)();const setValues=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((update,options)=>{const searchParams=new URLSearchParams(history.location.search);const newValues=Array.isArray(update)?update:update(searchParams.getAll(key));searchParams.delete(key);newValues.forEach(v=>searchParams.append(key,v));const updateHistory=options?.push?history.push:history.replace;updateHistory({search:searchParams.toString()});},[history,key]);return setValues;}function useQueryStringList(key){const values=useQueryStringListValues(key);const setValues=useQueryStringListUpdater(key);return[values,setValues];}function useClearQueryString(){const history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useHistory */ .W6)();return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(()=>{history.replace({search:undefined});},[history]);}
...
const DefaultAnimationEasing='ease-in-out';function useCollapsible(_ref){let{initialState}=_ref;const[collapsed,setCollapsed]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initialState??false);const toggleCollapsed=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(()=>{setCollapsed(expanded=>!expanded);},[]);return{collapsed,setCollapsed,toggleCollapsed};}const CollapsedStyles={display:'none',overflow:'hidden',height:'0px'};const ExpandedStyles={display:'block',overflow:'visible',height:'auto'};function applyCollapsedStyle(el,collapsed){const collapsedStyles=collapsed?CollapsedStyles:ExpandedStyles;el.style.display=collapsedStyles.display;el.style.overflow=collapsedStyles.overflow;el.style.height=collapsedStyles.height;}function getAutoHeightDuration(height){if((0,_utils_accessibilityUtils__WEBPACK_IMPORTED_MODULE_4__/* .prefersReducedMotion */ .O)()){return 1;}const constant=height/36;return Math.round((4+15*constant**0.25+constant/5)*10);}function useCollapseAnimation(_ref2){let{collapsibleRef,collapsed,animation}=_ref2;const mounted=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{const el=collapsibleRef.current;function getTransitionStyles(){const height=el.scrollHeight;const duration=animation?.duration??getAutoHeightDuration(height);const easing=animation?.easing??DefaultAnimationEasing;return{transition:`height ${duration}ms ${easing}`,height:`${height}px`};}function applyTransitionStyles(){const transitionStyles=getTransitionStyles();el.style.transition=transitionStyles.transition;el.style.height=transitionStyles.height;}if(!mounted.current){applyCollapsedStyle(el,collapsed);mounted.current=true;return undefined;}el.style.willChange='height';function startAnimation(){const animationFrame=requestAnimationFrame(()=>{if(collapsed){applyTransitionStyles();requestAnimationFrame(()=>{el.style.height=CollapsedStyles.height;el.style.overflow=CollapsedStyles.overflow;});}else{el.style.display='block';requestAnimationFrame(()=>{applyTransitionStyles();});}});return()=>cancelAnimationFrame(animationFrame);}return startAnimation();},[collapsibleRef,collapsed,animation]);}function getSSRStyle(_ref3){let{collapsed,isBrowser}=_ref3;if(isBrowser){return undefined;}return collapsed?CollapsedStyles:ExpandedStyles;}function CollapsibleBase(_ref4){let{as:As='div',collapsed,children,animation,onCollapseTransitionEnd,className,disableSSRStyle}=_ref4;const isBrowser=(0,_docusaurus_useIsBrowser__WEBPACK_IMPORTED_MODULE_1__["default"])();const collapsibleRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);useCollapseAnimation({collapsibleRef,collapsed,animation});return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(As,{ref:collapsibleRef,style:disableSSRStyle?undefined:getSSRStyle({collapsed,isBrowser}),onTransitionEnd:e=>{if(e.propertyName!=='height'){return;}applyCollapsedStyle(collapsibleRef.current,collapsed);onCollapseTransitionEnd?.(collapsed);},className:className,children:children});}function CollapsibleLazy(_ref5){let{collapsed,...props}=_ref5;const[mounted,setMounted]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(!collapsed);const[lazyCollapsed,setLazyCollapsed]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(collapsed);(0,_docusaurus_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(()=>{if(!collapsed){setMounted(true);}},[collapsed]);(0,_docusaurus_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(()=>{if(mounted){setLazyCollapsed(collapsed);}},[mounted,collapsed]);return mounted?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(CollapsibleBase,{...props,collapsed:lazyCollapsed}):null;}function Collapsible(_ref6){let{lazy,...props}=_ref6;const Comp=lazy?CollapsibleLazy:CollapsibleBase;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(Comp,{...props});}
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74848);
function SearchMetadata(_ref){let{locale,version,tag}=_ref;const language=locale;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,{children:[locale&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("meta",{name:"docusaurus_locale",content:locale}),version&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("meta",{name:"docusaurus_version",content:version}),tag&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("meta",{name:"docusaurus_tag",content:tag}),language&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("meta",{name:"docsearch:language",content:language}),version&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("meta",{name:"docsearch:version",content:version}),tag&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("meta",{name:"docsearch:docusaurus_tag",content:tag})]});}
...
/* harmony default export */ const client_modules = ([__webpack_require__(30166),__webpack_require__(67378),__webpack_require__(77264),__webpack_require__(78867),__webpack_require__(82094),__webpack_require__(55765)]);
...
var searchUtils = __webpack_require__(89396);
// EXTERNAL MODULE: ./node_modules/@docusaurus/utils-common/lib/index.js
var lib = __webpack_require__(30099);
...
function AlternateLangHeaders(){const{i18n:{currentLocale,defaultLocale,localeConfigs}}=(0,useDocusaurusContext["default"])();const alternatePageUtils=(0,useAlternatePageUtils/* useAlternatePageUtils */.o)();const currentHtmlLang=localeConfigs[currentLocale].htmlLang;const bcp47ToOpenGraphLocale=code=>code.replace('-','_');return/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[Object.entries(localeConfigs).map(_ref=>{let[locale,{htmlLang}]=_ref;return/*#__PURE__*/(0,jsx_runtime.jsx)("link",{rel:"alternate",href:alternatePageUtils.createUrl({locale,fullyQualified:true}),hrefLang:htmlLang},locale);}),/*#__PURE__*/(0,jsx_runtime.jsx)("link",{rel:"alternate",href:alternatePageUtils.createUrl({locale:defaultLocale,fullyQualified:true}),hrefLang:"x-default"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:locale",content:bcp47ToOpenGraphLocale(currentHtmlLang)}),Object.values(localeConfigs).filter(config=>currentHtmlLang!==config.htmlLang).map(config=>/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:locale:alternate",content:bcp47ToOpenGraphLocale(config.htmlLang)},`meta-og-${config.htmlLang}`))]});}function useDefaultCanonicalUrl(){const{siteConfig:{url:siteUrl,baseUrl,trailingSlash}}=(0,useDocusaurusContext["default"])();const{pathname}=(0,react_router/* useLocation */.zy)();const canonicalPathname=(0,lib/* applyTrailingSlash */.Ks)((0,useBaseUrl["default"])(pathname),{trailingSlash,baseUrl});return siteUrl+canonicalPathname;}function CanonicalUrlHeaders(_ref2){let{permalink}=_ref2;const{siteConfig:{url:siteUrl}}=(0,useDocusaurusContext["default"])();const defaultCanonicalUrl=useDefaultCanonicalUrl();const canonicalUrl=permalink?`${siteUrl}${permalink}`:defaultCanonicalUrl;return/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:url",content:canonicalUrl}),/*#__PURE__*/(0,jsx_runtime.jsx)("link",{rel:"canonical",href:canonicalUrl})]});}function SiteMetadata(){const{i18n:{currentLocale}}=(0,useDocusaurusContext["default"])();const{metadata,image:defaultImage}=(0,useThemeConfig/* useThemeConfig */.p)();return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:card",content:"summary_large_image"}),/*#__PURE__*/(0,jsx_runtime.jsx)("body",{className:useKeyboardNavigation/* keyboardFocusedClassName */.w})]}),defaultImage&&/*#__PURE__*/(0,jsx_runtime.jsx)(metadataUtils/* PageMetadata */.be,{image:defaultImage}),/*#__PURE__*/(0,jsx_runtime.jsx)(CanonicalUrlHeaders,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(AlternateLangHeaders,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(SearchMetadata/* default */.A,{tag:searchUtils/* DEFAULT_SEARCH_TAG */.C,locale:currentLocale}),/*#__PURE__*/(0,jsx_runtime.jsx)(Head/* default */.A,{children:metadata.map((metadatum,i)=>/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{...metadatum},i))})]});}
;// ./node_modules/@docusaurus/core/lib/client/normalizeLocation.js
const pathnames=new Map();function normalizeLocation(location){if(pathnames.has(location.pathname)){return{...location,pathname:pathnames.get(location.pathname)};}const matchedRoutes=(0,react_router_config/* matchRoutes */.u)(routes/* default */.A,location.pathname);if(matchedRoutes.some(_ref=>{let{route}=_ref;return route.exact===true;})){pathnames.set(location.pathname,location.pathname);return location;}const pathname=location.pathname.trim().replace(/(?:\/index)?\.html$/,'')||'/';pathnames.set(location.pathname,pathname);return{...location,pathname};}
...
class PendingNavigation extends react.Component{previousLocation;routeUpdateCleanupCb;constructor(props){super(props);this.previousLocation=null;this.routeUpdateCleanupCb=ExecutionEnvironment["default"].canUseDOM?dispatchLifecycleAction('onRouteUpdate',{previousLocation:null,location:this.props.location}):()=>{};this.state={nextRouteHasLoaded:true};}shouldComponentUpdate(nextProps,nextState){if(nextProps.location===this.props.location){return nextState.nextRouteHasLoaded;}const nextLocation=nextProps.location;this.previousLocation=this.props.location;this.setState({nextRouteHasLoaded:false});this.routeUpdateCleanupCb=dispatchLifecycleAction('onRouteUpdate',{previousLocation:this.previousLocation,location:nextLocation});preload(nextLocation.pathname).then(()=>{this.routeUpdateCleanupCb();this.setState({nextRouteHasLoaded:true});}).catch(e=>{console.warn(e);window.location.reload();});return false;}render(){const{children,location}=this.props;return/*#__PURE__*/(0,jsx_runtime.jsx)(client_ClientLifecyclesDispatcher,{previousLocation:this.previousLocation,location:location,children:/*#__PURE__*/(0,jsx_runtime.jsx)(react_router/* Route */.qh,{location:location,render:()=>children})});}}/* harmony default export */ const client_PendingNavigation = (PendingNavigation);
...
const BannerContainerId='__docusaurus-base-url-issue-banner-container';const BannerId='__docusaurus-base-url-issue-banner';const SuggestionContainerId='__docusaurus-base-url-issue-banner-suggestion-container';function createInlineHtmlBanner(baseUrl){return`
...
`;}function BaseUrlIssueBanner(){const{siteConfig:{baseUrl}}=(0,useDocusaurusContext["default"])();return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:!ExecutionEnvironment["default"].canUseDOM&&/*#__PURE__*/(0,jsx_runtime.jsx)(Head/* default */.A,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("script",{children:createInlineScript(baseUrl)})})});}function MaybeBaseUrlIssueBanner(){const{siteConfig:{baseUrl,baseUrlIssueBanner}}=(0,useDocusaurusContext["default"])();const{pathname}=(0,react_router/* useLocation */.zy)();const isHomePage=pathname===baseUrl;const enabled=baseUrlIssueBanner&&isHomePage;return enabled?/*#__PURE__*/(0,jsx_runtime.jsx)(BaseUrlIssueBanner,{}):null;}
;// ./node_modules/@docusaurus/core/lib/client/SiteMetadataDefaults.js
function SiteMetadataDefaults(){const{siteConfig:{favicon,title,noIndex},i18n:{currentLocale,localeConfigs}}=(0,useDocusaurusContext["default"])();const faviconUrl=(0,useBaseUrl["default"])(favicon);const{htmlLang,direction:htmlDir}=localeConfigs[currentLocale];return/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("html",{lang:htmlLang,dir:htmlDir}),/*#__PURE__*/(0,jsx_runtime.jsx)("title",{children:title}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:title",content:title}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),noIndex&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"robots",content:"noindex, nofollow"}),favicon&&/*#__PURE__*/(0,jsx_runtime.jsx)("link",{rel:"icon",href:faviconUrl})]});}
...
function HasHydratedDataAttribute(){const isBrowser=(0,useIsBrowser["default"])();return/*#__PURE__*/(0,jsx_runtime.jsx)(Head/* default */.A,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("html",{"data-has-hydrated":isBrowser})});}
...
const fetched=new Set();const loaded=new Set();const isSlowConnection=()=>navigator.connection?.effectiveType.includes('2g')||navigator.connection?.saveData;const canPrefetch=routePath=>!isSlowConnection()&&!loaded.has(routePath)&&!fetched.has(routePath);const canPreload=routePath=>!isSlowConnection()&&!loaded.has(routePath);const getChunkNamesToLoad=path=>Object.entries(routesChunkNames).filter(_ref=>{let[routeNameWithHash]=_ref;return routeNameWithHash.replace(/-[^-]+$/,'')===path;}).flatMap(_ref2=>{let[,routeChunks]=_ref2;return Object.values((0,flat/* default */.A)(routeChunks));});const docusaurus_prefetch=routePath=>{if(!canPrefetch(routePath)){return false;}fetched.add(routePath);const matches=(0,react_router_config/* matchRoutes */.u)(routes/* default */.A,routePath);const chunkNamesNeeded=matches.flatMap(match=>getChunkNamesToLoad(match.route.path));return Promise.all(chunkNamesNeeded.map(chunkName=>{const chunkAsset=__webpack_require__.gca(chunkName);if(chunkAsset&&!chunkAsset.includes('undefined')){return prefetch(chunkAsset);}return Promise.resolve();}));};const docusaurus_preload=routePath=>{if(!canPreload(routePath)){return false;}loaded.add(routePath);return preload(routePath);};const docusaurus={prefetch: docusaurus_prefetch,preload: docusaurus_preload};/* harmony default export */ const client_docusaurus = (Object.freeze(docusaurus));
;// ./node_modules/@docusaurus/core/lib/client/clientEntry.js
function Router(_ref){let{children}=_ref;return docusaurus_config["default"].future.experimental_router==='hash'?/*#__PURE__*/(0,jsx_runtime.jsx)(react_router_dom/* HashRouter */.I9,{children:children}):/*#__PURE__*/(0,jsx_runtime.jsx)(react_router_dom/* BrowserRouter */.Kd,{children:children});}const hydrate=Boolean(true);if(ExecutionEnvironment["default"].canUseDOM){window.docusaurus=client_docusaurus;const container=document.getElementById('__docusaurus');const app=/*#__PURE__*/(0,jsx_runtime.jsx)(index_module/* HelmetProvider */.vd,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Router,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(App,{})})});const onRecoverableError=(error,errorInfo)=>{console.error('Docusaurus React Root onRecoverableError:',error,errorInfo);};const renderApp=()=>{if(window.docusaurusRoot){window.docusaurusRoot.render(app);return;}if(hydrate){window.docusaurusRoot=client.hydrateRoot(container,app,{onRecoverableError});}else{const root=client.createRoot(container,{onRecoverableError});root.render(app);window.docusaurusRoot=root;}};preload(window.location.pathname).then(()=>{(0,react.startTransition)(renderApp);});if(false){}}
...
const globalData_namespaceObject = /*#__PURE__*/JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/en/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/en/docs","mainDocId":"configuration","docs":[{"id":"configuration","path":"/en/docs/configuration"},{"id":"import-resolution","path":"/en/docs/import-resolution"},{"id":"learn-python-typing","path":"/en/docs/learn-python-typing"}],"draftIds":[],"sidebars":{}}],"breadcrumbs":true}},"docusaurus-plugin-google-gtag":{"default":{"trackingID":["G-GSX14JC495"],"anonymizeIP":true,"id":"default"}},"docusaurus-lunr-search":{"default":{"fileNames":{"searchDoc":"search-doc-1743537947065.json","lunrIndex":"lunr-index-1743537947065.json"}}},"internaldocs-fb":{"default":{"opts":{"docs":{"routeBasePath":"en/docs","sidebarPath":false,"editUrl":"https://github.com/facebook/pyrefly/edit/main/website/","remarkPlugins":[[null,{"strippedFilePattern":{}}],[null,{}],[null,{"version":"v1"}],null],"rehypePlugins":[],"beforeDefaultRemarkPlugins":[[null,{}]]},"staticDocsProject":"Pyrefly","theme":{"customCss":"/home/runner/work/pyrefly/pyrefly/website/src/css/custom.css"},"enableEditor":true,"gtag":{"trackingID":"G-GSX14JC495","anonymizeIP":true},"id":"default"},"docsDir":"/home/runner/work/pyrefly/pyrefly/website/docs","repoRootToWebsiteRoot":"home/runner/work/pyrefly/pyrefly/website"}}}');
...
const site_metadata_namespaceObject = /*#__PURE__*/JSON.parse('{"docusaurusVersion":"3.7.0","siteVersion":"0.0.0","pluginVersions":{"docusaurus-plugin-content-docs":{"type":"package","name":"@docusaurus/plugin-content-docs","version":"3.7.0"},"docusaurus-plugin-content-blog":{"type":"package","name":"@docusaurus/plugin-content-blog","version":"3.7.0"},"docusaurus-plugin-content-pages":{"type":"package","name":"@docusaurus/plugin-content-pages","version":"3.7.0"},"docusaurus-plugin-google-gtag":{"type":"package","name":"@docusaurus/plugin-google-gtag","version":"3.7.0"},"docusaurus-plugin-sitemap":{"type":"package","name":"@docusaurus/plugin-sitemap","version":"3.7.0"},"docusaurus-plugin-svgr":{"type":"package","name":"@docusaurus/plugin-svgr","version":"3.7.0"},"docusaurus-lunr-search":{"type":"package","name":"docusaurus-lunr-search","version":"2.4.2"},"docusaurus-theme-classic":{"type":"package","name":"@docusaurus/theme-classic","version":"3.7.0"},"internaldocs-fb":{"type":"package","name":"docusaurus-plugin-internaldocs-fb","version":"1.19.1"},"docusaurus-fb-search-theme":{"type":"local"},"polyfillNodeBuiltinsForFlowJS":{"type":"local"},"enableSomeEnvVarsAsBuildTimeConstants":{"type":"local"},"enableMonacoEditorPlugin":{"type":"local"},"stylex-docusaurus":{"type":"local"},"docusaurus-theme-mermaid":{"type":"package","name":"@docusaurus/theme-mermaid","version":"3.7.0"}}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
/* harmony default export */ const registry = ({"17896441":[()=>Promise.all(/* import() */[__webpack_require__.e(1869), __webpack_require__.e(2076), __webpack_require__.e(9214), __webpack_require__.e(5503)]).then(__webpack_require__.t.bind(__webpack_require__, 65429, 23)),"@theme/DocItem",/*require.resolve*/(65429)],"1b82301a":[()=>Promise.all(/* import() */[__webpack_require__.e(2076), __webpack_require__.e(5839)]).then(__webpack_require__.bind(__webpack_require__, 65839)),"@site/docs/import-resolution.mdx",/*require.resolve*/(65839)],"1df93b7f":[()=>Promise.all(/* import() */[__webpack_require__.e(1869), __webpack_require__.e(6107)]).then(__webpack_require__.bind(__webpack_require__, 46107)),"@site/src/pages/index.tsx",/*require.resolve*/(46107)],"537b867c":[()=>__webpack_require__.e(/* import() */ 3111).then(__webpack_require__.t.bind(__webpack_require__, 3111, 19)),"@generated/docusaurus-plugin-content-docs/default/p/en-docs-c58.json",/*require.resolve*/(3111)],"5e95c892":[()=>__webpack_require__.e(/* import() */ 8122).then(__webpack_require__.bind(__webpack_require__, 18122)),"@theme/DocsRoot",/*require.resolve*/(18122)],"5e9f5e1a":[()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 4784)),"@generated/docusaurus.config",/*require.resolve*/(4784)],"a7456010":[()=>__webpack_require__.e(/* import() */ 8552).then(__webpack_require__.t.bind(__webpack_require__, 88552, 19)),"@generated/docusaurus-plugin-content-pages/default/__plugin.json",/*require.resolve*/(88552)],"a7bd4aaa":[()=>__webpack_require__.e(/* import() */ 5047).then(__webpack_require__.bind(__webpack_require__, 15047)),"@theme/DocVersionRoot",/*require.resolve*/(15047)],"a94703ab":[()=>Promise.all(/* import() */[__webpack_require__.e(1869), __webpack_require__.e(1841)]).then(__webpack_require__.bind(__webpack_require__, 91841)),"@theme/DocRoot",/*require.resolve*/(91841)],"aba21aa0":[()=>__webpack_require__.e(/* import() */ 7093).then(__webpack_require__.t.bind(__webpack_require__, 27093, 19)),"@generated/docusaurus-plugin-content-docs/default/__plugin.json",/*require.resolve*/(27093)],"cbb899e4":[()=>Promise.all(/* import() */[__webpack_require__.e(2076), __webpack_require__.e(3028)]).then(__webpack_require__.bind(__webpack_require__, 83028)),"@site/docs/configuration.mdx",/*require.resolve*/(83028)],"dda49074":[()=>__webpack_require__.e(/* import() */ 9108).then(__webpack_require__.bind(__webpack_require__, 59108)),"@site/src/pages/try.tsx",/*require.resolve*/(59108)],"ddce6c53":[()=>Promise.all(/* import() */[__webpack_require__.e(1869), __webpack_require__.e(3872)]).then(__webpack_require__.bind(__webpack_require__, 73872)),"@site/src/pages/newLandingPage.tsx",/*require.resolve*/(73872)],"ed255459":[()=>Promise.all(/* import() */[__webpack_require__.e(2076), __webpack_require__.e(2060)]).then(__webpack_require__.bind(__webpack_require__, 22060)),"@site/docs/learn-python-typing.mdx",/*require.resolve*/(22060)]});
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./node_modules/@docusaurus/core/lib/client/theme-fallback/Loading/index.js
function Loading(_ref){let{error,retry,pastDelay}=_ref;if(error){return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{textAlign:'center',color:'#fff',backgroundColor:'#fa383e',borderColor:'#fa383e',borderStyle:'solid',borderRadius:'0.25rem',borderWidth:'1px',boxSizing:'border-box',display:'block',padding:'1rem',flex:'0 0 50%',marginLeft:'25%',marginRight:'25%',marginTop:'5rem',maxWidth:'50%',width:'100%'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("p",{children:String(error)}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:/*#__PURE__*/(0,jsx_runtime.jsx)("button",{type:"button",onClick:retry,children:"Retry"})})]});}if(pastDelay){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{display:'flex',justifyContent:'center',alignItems:'center',height:'100vh'},children:/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{id:"loader",style:{width:128,height:110,position:'absolute',top:'calc(100vh - 64%)'},viewBox:"0 0 45 45",xmlns:"http://www.w3.org/2000/svg",stroke:"#61dafb",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("g",{fill:"none",fillRule:"evenodd",transform:"translate(1 1)",strokeWidth:"2",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("circle",{cx:"22",cy:"22",r:"6",strokeOpacity:"0",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"r",begin:"1.5s",dur:"3s",values:"6;22",calcMode:"linear",repeatCount:"indefinite"}),/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"stroke-opacity",begin:"1.5s",dur:"3s",values:"1;0",calcMode:"linear",repeatCount:"indefinite"}),/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"stroke-width",begin:"1.5s",dur:"3s",values:"2;0",calcMode:"linear",repeatCount:"indefinite"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("circle",{cx:"22",cy:"22",r:"6",strokeOpacity:"0",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"r",begin:"3s",dur:"3s",values:"6;22",calcMode:"linear",repeatCount:"indefinite"}),/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"stroke-opacity",begin:"3s",dur:"3s",values:"1;0",calcMode:"linear",repeatCount:"indefinite"}),/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"stroke-width",begin:"3s",dur:"3s",values:"2;0",calcMode:"linear",repeatCount:"indefinite"})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("circle",{cx:"22",cy:"22",r:"8",children:/*#__PURE__*/(0,jsx_runtime.jsx)("animate",{attributeName:"r",begin:"0s",dur:"1.5s",values:"6;1;2;3;4;5;6",calcMode:"linear",repeatCount:"indefinite"})})]})})});}return null;}
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/flat.js
var flat = __webpack_require__(13722);
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/routeContext.js
var client_routeContext = __webpack_require__(75313);
;// ./node_modules/@docusaurus/core/lib/client/exports/ComponentCreator.js
function ComponentCreator(path,hash){if(path==='*'){return lib_default()({loading:Loading,loader:()=>__webpack_require__.e(/* import() */ 3042).then(__webpack_require__.bind(__webpack_require__, 73042)),modules:['@theme/NotFound'],webpack:()=>[/*require.resolve*/(73042)],render(loaded,props){const NotFound=loaded.default;return/*#__PURE__*/(0,jsx_runtime.jsx)(client_routeContext/* RouteContextProvider */.W,{value:{plugin:{name:'native',id:'default'}},children:/*#__PURE__*/(0,jsx_runtime.jsx)(NotFound,{...props})});}});}const chunkNames=routesChunkNames[`${path}-${hash}`];const loader={};const modules=[];const optsWebpack=[];const flatChunkNames=(0,flat/* default */.A)(chunkNames);Object.entries(flatChunkNames).forEach(_ref=>{let[keyPath,chunkName]=_ref;const chunkRegistry=registry[chunkName];if(chunkRegistry){loader[keyPath]=chunkRegistry[0];modules.push(chunkRegistry[1]);optsWebpack.push(chunkRegistry[2]);}});return lib_default().Map({loading:Loading,loader,modules,webpack:()=>optsWebpack,render(loaded,props){const loadedModules=JSON.parse(JSON.stringify(chunkNames));Object.entries(loaded).forEach(_ref2=>{let[keyPath,loadedModule]=_ref2;const chunk=loadedModule.default;if(!chunk){throw new Error(`The page component at ${path} doesn't have a default export. This makes it impossible to render anything. Consider default-exporting a React component.`);}if(typeof chunk==='object'||typeof chunk==='function'){Object.keys(loadedModule).filter(k=>k!=='default').forEach(nonDefaultKey=>{chunk[nonDefaultKey]=loadedModule[nonDefaultKey];});}let val=loadedModules;const keyPaths=keyPath.split('.');keyPaths.slice(0,-1).forEach(k=>{val=val[k];});val[keyPaths[keyPaths.length-1]]=chunk;});const Component=loadedModules.__comp;delete loadedModules.__comp;const routeContext=loadedModules.__context;delete loadedModules.__context;const routeProps=loadedModules.__props;delete loadedModules.__props;return/*#__PURE__*/(0,jsx_runtime.jsx)(client_routeContext/* RouteContextProvider */.W,{value:routeContext,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Component,{...loadedModules,...routeProps,...props})});}});}
;// ./.docusaurus/routes.js
/* harmony default export */ const routes = ([{path:'/newLandingPage/',component:ComponentCreator('/newLandingPage/','a69'),exact:true},{path:'/try/',component:ComponentCreator('/try/','d7a'),exact:true},{path:'/en/docs/',component:ComponentCreator('/en/docs/','0d9'),routes:[{path:'/en/docs/',component:ComponentCreator('/en/docs/','ffd'),routes:[{path:'/en/docs/',component:ComponentCreator('/en/docs/','384'),routes:[{path:'/en/docs/configuration/',component:ComponentCreator('/en/docs/configuration/','fe1'),exact:true},{path:'/en/docs/import-resolution/',component:ComponentCreator('/en/docs/import-resolution/','573'),exact:true},{path:'/en/docs/learn-python-typing/',component:ComponentCreator('/en/docs/learn-python-typing/','677'),exact:true}]}]}]},{path:'/',component:ComponentCreator('/','e5f'),exact:true},{path:'*',component:ComponentCreator('*')}]);
...
"use strict";
var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{"default":mod};};Object.defineProperty(exports, "__esModule", ({value:true}));const zepto_1=__importDefault(__webpack_require__(53704));const utils={mergeKeyWithParent(object,property){if(object[property]===undefined){return object;}if(typeof object[property]!=='object'){return object;}const newObject=zepto_1.default.extend({},object,object[property]);delete newObject[property];return newObject;},groupBy(collection,property){const newCollection={};zepto_1.default.each(collection,(index,item)=>{if(item[property]===undefined){throw new Error(`[groupBy]: Object has no key ${property}`);}let key=item[property];if(typeof key==='string'){key=key.toLowerCase();}if(!Object.prototype.hasOwnProperty.call(newCollection,key)){newCollection[key]=[];}newCollection[key].push(item);});return newCollection;},values(object){return Object.keys(object).map(key=>object[key]);},flatten(array){const results=[];array.forEach(value=>{if(!Array.isArray(value)){results.push(value);return;}value.forEach(subvalue=>{results.push(subvalue);});});return results;},flattenAndFlagFirst(object,flag){const values=this.values(object).map(collection=>collection.map((item,index)=>{item[flag]=index===0;return item;}));return this.flatten(values);},compact(array){const results=[];array.forEach(value=>{if(!value){return;}results.push(value);});return results;},getHighlightedValue(object,property){if(object._highlightResult&&object._highlightResult.hierarchy_camel&&object._highlightResult.hierarchy_camel[property]&&object._highlightResult.hierarchy_camel[property].matchLevel&&object._highlightResult.hierarchy_camel[property].matchLevel!=='none'&&object._highlightResult.hierarchy_camel[property].value){return object._highlightResult.hierarchy_camel[property].value;}if(object._highlightResult&&object._highlightResult&&object._highlightResult[property]&&object._highlightResult[property].value){return object._highlightResult[property].value;}return object[property];},getSnippetedValue(object,property){if(!object._snippetResult||!object._snippetResult[property]||!object._snippetResult[property].value){return object[property];}let snippet=object._snippetResult[property].value;if(snippet[0]!==snippet[0].toUpperCase()){snippet=`…${snippet}`;}if(['.','!','?'].indexOf(snippet[snippet.length-1])===-1){snippet=`${snippet}…`;}return snippet;},deepClone(object){return JSON.parse(JSON.stringify(object));}};exports["default"]=utils;
...
const useIsomorphicLayoutEffect=_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_1__["default"].canUseDOM?react__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect:react__WEBPACK_IMPORTED_MODULE_0__.useEffect;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useIsomorphicLayoutEffect);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(79231);
...
"use strict";
var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{"default":mod};};Object.defineProperty(exports, "__esModule", ({value:true}));const ExecutionEnvironment_1=__importDefault(__webpack_require__(61934));const internal_1=__webpack_require__(78191);const INITIAL_SLASH=/^\//;const TRAILING_SLASH=/\/$/;const ABSOLUTE_PATH_REGEX=/^https?:\/\//i;const LOCAL_STORAGE_AUTO_REDIRECT_KEY='__internaldocs_auto_redirect';const STATIC_DOMAIN_NAME='thefacebook.com';const STATICDOCS_DOMAIN_NAME=`staticdocs.${STATIC_DOMAIN_NAME}`;const INTERN_DOMAIN_NAME='internalfb.com';const STATICDOCS_INTERN_PATH='/intern/staticdocs';const CHECK_URL='https://www.internalfb.com/intern/internaldocs/check';const NETWORK_TEST_URL='https://staticdocs.thefacebook.com/ping';const DISABLE_REDIRECT_PARAM='disableRedirect';const HIDE_NAVIGATION_PARAM='hideNavigation';const TAG='[docusaurus-plugin-internaldocs-fb]';function hasQueryValue(key){return new URLSearchParams(window.location.search).get(key)!==null;}function setSiteThemeFromQuery(){if(typeof window!=='undefined'){const queryTheme=new window.URLSearchParams(window.location.search).get('_sdoc_theme');if(queryTheme==='light'||queryTheme==='dark'){document.documentElement.setAttribute('data-theme',queryTheme);}}}exports["default"]=function(){function __internaldocs_set_redirect(notNecessarilyWindowLocation){if(window.location.hostname.endsWith(INTERN_DOMAIN_NAME)){return;}if(window.top==window.self&&window.location.hostname.endsWith(`.${STATIC_DOMAIN_NAME}`)&&!hasQueryValue(DISABLE_REDIRECT_PARAM)){const newUrl=new URL(window.location.href);newUrl.hostname=INTERN_DOMAIN_NAME;newUrl.port='';if(window.location.hostname===STATICDOCS_DOMAIN_NAME){newUrl.pathname=STATICDOCS_INTERN_PATH+notNecessarilyWindowLocation.pathname;}else{newUrl.pathname=STATICDOCS_INTERN_PATH+window.location.hostname.split('.')[0]+notNecessarilyWindowLocation.pathname;}console.log(`${TAG} Redirecting to ${newUrl.href}`);window.location.href=newUrl.href;return;}const controller=new AbortController();const timeout=setTimeout(()=>controller.abort(),2000);fetch(NETWORK_TEST_URL,{signal:controller.signal}).then(()=>{clearTimeout(timeout);fetch(CHECK_URL,{credentials:'include',referrerPolicy:'no-referrer-when-downgrade'}).then(r=>r.json()).then(response=>handleCheckResponse(response)).catch(()=>{});}).catch(()=>{});}function handleCheckResponse(response){if(!response.showBanner||!response.redirectTo||!response.template){return;}const banner=document.getElementById('internaldocs-banner');if(banner){const currentUrl=location.href;const currentHost=new URL(currentUrl).host;const currentPathAndEverythingAfter=currentUrl.slice(currentUrl.indexOf(currentHost)+currentHost.length);const url=response.redirectTo.replace(TRAILING_SLASH,'')+'/'+(currentPathAndEverythingAfter?currentPathAndEverythingAfter.replace(INITIAL_SLASH,''):'');if(hasQueryValue(DISABLE_REDIRECT_PARAM)){console.log(`${TAG}  Disabling redirect because of query parameter`);setRedirectEnabled(false);}if(response.autoRedirectEnabled&&isRedirectEnabled()){console.log(`${TAG}  Redirecting to ${url}`);window.location.href=url;}updateBanner(banner,response.template,url,response.autoRedirectEnabled);}}function updateBanner(bannerElement,template,redirectDestination,isAutoRedirectEnabled){const matches=template.match(/(.*)\{\{([^}]+)\}\}(.*)/);if(!matches){return;}const before=matches[1]||'';const linkText=matches[2]||'';const after=matches[3]||'';Array.from(bannerElement.childNodes).map(node=>bannerElement.removeChild(node));bannerElement.appendChild(document.createTextNode(before));const linkElement=document.createElement('a');linkElement.href=redirectDestination;linkElement.style.color='#3578e5';linkElement.appendChild(document.createTextNode(linkText));bannerElement.appendChild(linkElement);bannerElement.appendChild(document.createTextNode(after));const rememberParagraph=document.createElement('p');rememberParagraph.style.fontSize='11px';rememberParagraph.style.marginBottom='3px';const checkbox=document.createElement('input');checkbox.id='internaldocs-remember-checkbox';checkbox.type='checkbox';checkbox.style.height='8px';checkbox.checked=isRedirectEnabled();checkbox.addEventListener('change',()=>{setRedirectEnabled(Boolean(checkbox.checked));});rememberParagraph.appendChild(checkbox);if(isAutoRedirectEnabled){bannerElement.appendChild(rememberParagraph);}const label=document.createElement('label');label.htmlFor='internaldocs-remember-checkbox';label.appendChild(document.createTextNode('Redirect me automatically in future'));rememberParagraph.appendChild(label);bannerElement.style.display='block';}function sendPageUpdate(){setTimeout(()=>{var _a;(_a=window.parent)===null||_a===void 0?void 0:_a.postMessage({event:'page-update',title:document.title,location:window.location.href,version:2},'*');},0);}function isRedirectEnabled(){const setting=localStorage.getItem(LOCAL_STORAGE_AUTO_REDIRECT_KEY);if(setting==='true'){console.log(`${TAG} opted in to auto redirects`);return true;}if(setting==='false'){console.log(`${TAG} opted out of auto redirects`);return false;}console.log(`${TAG} using default auto-redirect behaviour: true`);return true;}function setRedirectEnabled(shouldRedirect){localStorage.setItem(LOCAL_STORAGE_AUTO_REDIRECT_KEY,shouldRedirect?'true':'false');}function hideNavigation(){var _a,_b,_c,_d,_e,_f,_g,_h,_j;(_a=document.querySelector('aside'))===null||_a===void 0?void 0:_a.style.setProperty('display','none');(_b=document.querySelectorAll('.footer'))===null||_b===void 0?void 0:_b.forEach(element=>{element.style.setProperty('display','none');});(_c=document.querySelectorAll('.pagination-nav'))===null||_c===void 0?void 0:_c.forEach(element=>{element.style.setProperty('display','none');});(_d=document.querySelectorAll('.theme-edit-this-page'))===null||_d===void 0?void 0:_d.forEach(element=>{element.style.setProperty('display','none');});(_e=document.querySelector('nav'))===null||_e===void 0?void 0:_e.style.setProperty('display','none');(_f=document.querySelector('main'))===null||_f===void 0?void 0:_f.style.setProperty('max-width','100%');(_g=document.querySelectorAll('.theme-doc-toc-mobile'))===null||_g===void 0?void 0:_g.forEach(element=>{element.style.setProperty('display','none');});(_h=document.querySelectorAll('.theme-doc-footer'))===null||_h===void 0?void 0:_h.forEach(element=>{element.style.setProperty('display','none');});(_j=document.querySelectorAll('#editor-trigger'))===null||_j===void 0?void 0:_j.forEach(element=>{element.style.setProperty('display','none');});}function isRelativeUrl(target){if(target.tagName=='A'&&target.hasAttribute('href')){const href=target.getAttribute('href');if(href!==null&&!ABSOLUTE_PATH_REGEX.test(href)){return true;}}return false;}if(ExecutionEnvironment_1.default.canUseDOM){__internaldocs_set_redirect(window.location);sendPageUpdate();document.addEventListener('copy',()=>{const selection=document.getSelection();if(!selection){return;}internal_1.feedback.reportContentCopied({textContent:selection.toString()});});if(hasQueryValue(HIDE_NAVIGATION_PARAM)){document.addEventListener('click',event=>{var _a;const target=event.target;if(isRelativeUrl(target)){event.preventDefault();(_a=window.parent)===null||_a===void 0?void 0:_a.postMessage({event:'static-docs-link-click',location:target.getAttribute('href')},'*');}},true);}}setSiteThemeFromQuery();const mod={onRouteUpdate:_ref=>{let{location}=_ref;__internaldocs_set_redirect(location);sendPageUpdate();},onRouteDidUpdate:()=>{if(hasQueryValue(HIDE_NAVIGATION_PARAM)){hideNavigation();}}};return mod;}();
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74848);
const shouldAddBaseUrlAutomatically=to=>to.startsWith('/');function Link(_ref,forwardedRef){let{isNavLink,to,href,activeClassName,isActive,'data-noBrokenLinkCheck':noBrokenLinkCheck,autoAddBaseUrl=true,...props}=_ref;const{siteConfig}=(0,_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_1__["default"])();const{trailingSlash,baseUrl}=siteConfig;const router=siteConfig.future.experimental_router;const{withBaseUrl}=(0,_useBaseUrl__WEBPACK_IMPORTED_MODULE_4__.useBaseUrlUtils)();const brokenLinks=(0,_useBrokenLinks__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)();const innerRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);(0,react__WEBPACK_IMPORTED_MODULE_0__.useImperativeHandle)(forwardedRef,()=>innerRef.current);const targetLinkUnprefixed=to||href;function maybeAddBaseUrl(str){return autoAddBaseUrl&&shouldAddBaseUrlAutomatically(str)?withBaseUrl(str):str;}const isInternal=(0,_isInternalUrl__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(targetLinkUnprefixed);const targetLinkWithoutPathnameProtocol=targetLinkUnprefixed?.replace('pathname://','');let targetLink=typeof targetLinkWithoutPathnameProtocol!=='undefined'?maybeAddBaseUrl(targetLinkWithoutPathnameProtocol):undefined;if(router==='hash'&&targetLink?.startsWith('./')){targetLink=targetLink?.slice(1);}if(targetLink&&isInternal){targetLink=(0,_docusaurus_utils_common__WEBPACK_IMPORTED_MODULE_7__/* .applyTrailingSlash */ .Ks)(targetLink,{trailingSlash,baseUrl});}const preloaded=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);const LinkComponent=isNavLink?react_router_dom__WEBPACK_IMPORTED_MODULE_8__/* .NavLink */ .k2:react_router_dom__WEBPACK_IMPORTED_MODULE_8__/* .Link */ .N_;const IOSupported=_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_2__["default"].canUseIntersectionObserver;const ioRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();const handleRef=el=>{innerRef.current=el;if(IOSupported&&el&&isInternal){ioRef.current=new window.IntersectionObserver(entries=>{entries.forEach(entry=>{if(el===entry.target){if(entry.isIntersecting||entry.intersectionRatio>0){ioRef.current.unobserve(el);ioRef.current.disconnect();if(targetLink!=null){window.docusaurus.prefetch(targetLink);}}}});});ioRef.current.observe(el);}};const onInteractionEnter=()=>{if(!preloaded.current&&targetLink!=null){window.docusaurus.preload(targetLink);preloaded.current=true;}};(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(!IOSupported&&isInternal&&_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_2__["default"].canUseDOM){if(targetLink!=null){window.docusaurus.prefetch(targetLink);}}return()=>{if(IOSupported&&ioRef.current){ioRef.current.disconnect();}};},[ioRef,targetLink,IOSupported,isInternal]);const isAnchorLink=targetLink?.startsWith('#')??false;const hasInternalTarget=!props.target||props.target==='_self';const isRegularHtmlLink=!targetLink||!isInternal||!hasInternalTarget||isAnchorLink&&router!=='hash';if(!noBrokenLinkCheck&&(isAnchorLink||!isRegularHtmlLink)){brokenLinks.collectLink(targetLink);}if(props.id){brokenLinks.collectAnchor(props.id);}const testOnlyProps= false?0:{};return isRegularHtmlLink?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("a",{ref:innerRef,href:targetLink,...(targetLinkUnprefixed&&!isInternal&&{target:'_blank',rel:'noopener noreferrer'}),...props,...testOnlyProps}):/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(LinkComponent,{...props,onMouseEnter:onInteractionEnter,onTouchStart:onInteractionEnter,innerRef:handleRef,to:targetLink,...(isNavLink&&{isActive,activeClassName}),...testOnlyProps});}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(Link));
...
/* harmony export */ });
/* unused harmony exports MemoryRouter, Prompt, StaticRouter, __HistoryContext, generatePath, useParams, useRouteMatch, withRouter */
...
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(79231);
...
function Redirect(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Consumer, null, function (context) {
    ...
    var location = (0,history__WEBPACK_IMPORTED_MODULE_6__/* .createLocation */ .yJ)(computedMatch ? typeof to === "string" ? generatePath(to, computedMatch.params) : (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)({}, to, {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Lifecycle, {
      ...
      onUpdate: function onUpdate(self, prevProps) {
        var prevLocation = (0,history__WEBPACK_IMPORTED_MODULE_6__/* .createLocation */ .yJ)(prevProps.to);

        if (!(0,history__WEBPACK_IMPORTED_MODULE_6__/* .locationsAreEqual */ .Fu)(prevLocation, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)({}, location, {
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74848);
const Context=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(null);function NavbarSecondaryMenuContentProvider(_ref){let{children}=_ref;const value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({component:null,props:null});return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Context.Provider,{value:value,children:children});}function useNavbarSecondaryMenuContent(){const value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(!value){throw new _utils_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .ReactContextError */ .dV('NavbarSecondaryMenuContentProvider');}return value[0];}function NavbarSecondaryMenuFiller(_ref2){let{component,props}=_ref2;const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(!context){throw new _utils_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .ReactContextError */ .dV('NavbarSecondaryMenuContentProvider');}const[,setContent]=context;const memoizedProps=(0,_utils_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .useShallowMemoObject */ .Be)(props);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{setContent({component,props:memoizedProps});},[setContent,component,memoizedProps]);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>()=>setContent({component:null,props:null}),[setContent]);return null;}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.gk=exports.getGKs=void 0;const bridge_1=__webpack_require__(67826);function getGKs(){return(0,bridge_1.call)({module:'gks',api:'getGKs',args:{}});}exports.getGKs=getGKs;const cache={};function gk(gk_name){if(gk_name in cache){return Promise.resolve(cache[gk_name]);}else{return getGKs().then(data=>{cache[gk_name]=data.xfb_static_docs_query.static_docs_gks.findIndex(x=>x.name==gk_name)!==-1?true:false;return cache[gk_name];}).catch(()=>{cache[gk_name]=false;return cache[gk_name];});}}exports.gk=gk;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.call=void 0;let isInitialised=false;let globalId=0;const promises={};const STATIC_DOCS_HOSTS=['localhost'];const STATIC_DOCS_HOST_SUFFIX='.internalfb.com';function init(){if(isInitialised){return;}isInitialised=true;window.addEventListener('message',event=>{if(event.data.event!=='static-docs-bridge-response'){return;}const id=event.data.id;if(!(id in promises)){console.error(`Recieved response for id: ${id} with no matching receiver`);}if('response'in event.data){promises[id].resolve(event.data.response);}else{promises[id].reject(new Error(event.data.error));}delete promises[id];});}const PARENT_HOSTNAME=typeof window!=='undefined'&&new URL(window.location.href).searchParams.get('parentHostname')||'https://www.internalfb.com';function call(params){if(!STATIC_DOCS_HOSTS.includes(window.location.hostname)&&!window.location.hostname.endsWith(STATIC_DOCS_HOST_SUFFIX)){return Promise.reject(new Error('Not running on static docs'));}init();const id=globalId++;const promise=new Promise((resolve,reject)=>{promises[id]={resolve,reject};});const message={event:'static-docs-bridge-call',id:id,module:params.module,api:params.api,args:params.args};const target=window.location.hostname==='localhost'?'*':PARENT_HOSTNAME;window.parent.postMessage(message,target);return promise;}exports.call=call;
...
function useAlternatePageUtils(){const{siteConfig:{baseUrl,url,trailingSlash},i18n:{defaultLocale,currentLocale}}=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_0__["default"])();const{pathname}=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useLocation */ .zy)();const canonicalPathname=(0,_docusaurus_utils_common__WEBPACK_IMPORTED_MODULE_2__/* .applyTrailingSlash */ .Ks)(pathname,{trailingSlash,baseUrl});const baseUrlUnlocalized=currentLocale===defaultLocale?baseUrl:baseUrl.replace(`/${currentLocale}/`,'/');const pathnameSuffix=canonicalPathname.replace(baseUrl,'');function getLocalizedBaseUrl(locale){return locale===defaultLocale?`${baseUrlUnlocalized}`:`${baseUrlUnlocalized}${locale}/`;}function createUrl(_ref){let{locale,fullyQualified}=_ref;return`${fullyQualified?url:''}${getLocalizedBaseUrl(locale)}${pathnameSuffix}`;}return{createUrl};}
...
const AllThemes=(/* unused pure expression or super */ null && (['light','dark']));function ThemedComponent(_ref){let{className,children}=_ref;const isBrowser=(0,useIsBrowser["default"])();const{colorMode}=(0,contexts_colorMode/* useColorMode */.G)();function getThemesToRender(){if(isBrowser){return colorMode==='dark'?['dark']:['light'];}return['light','dark'];}return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:getThemesToRender().map(theme=>{const themedElement=children({theme,className:(0,clsx/* default */.A)(className,styles_module.themedComponent,styles_module[`themedComponent--${theme}`])});return/*#__PURE__*/(0,jsx_runtime.jsx)(react.Fragment,{children:themedElement},theme);})});}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (lunr__WEBPACK_IMPORTED_MODULE_0__);
...
// UNUSED EXPORTS: DocProvider, DocSidebarItemsExpandedStateProvider, DocsPreferredVersionContextProvider, DocsSidebarProvider, DocsVersionProvider, findFirstSidebarItemLink, findSidebarCategory, getDocsVersionSearchTag, isActiveSidebarItem, isVisibleSidebarItem, useActiveVersion, useDoc, useDocById, useDocRootMetadata, useDocSidebarItemsExpandedState, useDocsPreferredVersionByPluginId, useDocsSidebar, useDocsVersion, useDocsVersionCandidates, useLayoutDoc, useLayoutDocsSidebar, useSidebarBreadcrumbs, useVisibleSidebarItems
...
var docsSearch = __webpack_require__(23716);
;// ./node_modules/@docusaurus/plugin-content-docs/lib/client/index.js
const StableEmptyObject={};const useAllDocsData=()=>(0,useGlobalData.useAllPluginInstancesData)('docusaurus-plugin-content-docs')??StableEmptyObject;const useDocsData=pluginId=>{try{return (0,useGlobalData.usePluginData)('docusaurus-plugin-content-docs',pluginId,{failfast:true});}catch(error){throw new Error(`You are using a feature of the Docusaurus docs plugin, but this plugin does not seem to be enabled${pluginId==='Default'?'':` (pluginId=${pluginId}`}`,{cause:error});}};function useActivePlugin(options){if(options===void 0){options={};}const data=useAllDocsData();const{pathname}=(0,react_router/* useLocation */.zy)();return getActivePlugin(data,pathname,options);}function useActivePluginAndVersion(options){if(options===void 0){options={};}const activePlugin=useActivePlugin(options);const{pathname}=(0,react_router/* useLocation */.zy)();if(!activePlugin){return undefined;}const activeVersion=docsClientUtils_getActiveVersion(activePlugin.pluginData,pathname);return{activePlugin,activeVersion};}function useVersions(pluginId){const data=useDocsData(pluginId);return data.versions;}function useLatestVersion(pluginId){const data=useDocsData(pluginId);return getLatestVersion(data);}function useActiveVersion(pluginId){const data=useDocsData(pluginId);const{pathname}=useLocation();return getActiveVersion(data,pathname);}function useActiveDocContext(pluginId){const data=useDocsData(pluginId);const{pathname}=(0,react_router/* useLocation */.zy)();return getActiveDocContext(data,pathname);}function useDocVersionSuggestions(pluginId){const data=useDocsData(pluginId);const{pathname}=(0,react_router/* useLocation */.zy)();return getDocVersionSuggestions(data,pathname);}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.display=void 0;const bridge_1=__webpack_require__(67826);const noop=()=>{};function display(args){const{componentName,posX,posY,props}=args;return(0,bridge_1.call)({module:'interncomponent',api:'displayComponent',args:{componentName,posX,posY,props}}).then(noop).catch(noop);}exports.display=display;
...
var dist = __webpack_require__(78181);
// EXTERNAL MODULE: ./.docusaurus/docusaurus.config.mjs
var docusaurus_config = __webpack_require__(4784);
;// ./node_modules/@docusaurus/theme-classic/lib/theme/prism-include-languages.js
function prismIncludeLanguages(PrismObject){const{themeConfig:{prism}}=docusaurus_config["default"];const{additionalLanguages}=prism;const PrismBefore=globalThis.Prism;globalThis.Prism=PrismObject;additionalLanguages.forEach(lang=>{if(lang==='php'){__webpack_require__(19700);}__webpack_require__(18692)(`./prism-${lang}`);});delete globalThis.Prism;if(typeof PrismBefore!=='undefined'){globalThis.Prism=PrismObject;}}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  f4: () => (/* binding */ Highlight2),
  My: () => (/* binding */ Prism)
});

// UNUSED EXPORTS: normalizeTokens, themes, useTokenize
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(o,m,k,k2){if(k2===undefined)k2=k;var desc=Object.getOwnPropertyDescriptor(m,k);if(!desc||("get"in desc?!m.__esModule:desc.writable||desc.configurable)){desc={enumerable:true,get:function(){return m[k];}};}Object.defineProperty(o,k2,desc);}:function(o,m,k,k2){if(k2===undefined)k2=k;o[k2]=m[k];});var __setModuleDefault=this&&this.__setModuleDefault||(Object.create?function(o,v){Object.defineProperty(o,"default",{enumerable:true,value:v});}:function(o,v){o["default"]=v;});var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(mod!=null)for(var k in mod)if(k!=="default"&&Object.prototype.hasOwnProperty.call(mod,k))__createBinding(result,mod,k);__setModuleDefault(result,mod);return result;};Object.defineProperty(exports, "__esModule", ({value:true}));exports.OssOnly=exports.FbInternalOnly=exports.getEphemeralDiffNumber=exports.hasEphemeralDiffNumber=exports.isInternal=exports.validateFbContentArgs=exports.fbInternalOnly=exports.fbContent=exports.metagenServiceStatus=exports.internComponent=exports.checkGKs=exports.inpageeditor=exports.feedback=exports.uidocs=exports.bloks=void 0;exports.bloks=__importStar(__webpack_require__(22838));exports.uidocs=__importStar(__webpack_require__(86154));exports.feedback=__importStar(__webpack_require__(24160));exports.inpageeditor=__importStar(__webpack_require__(87690));exports.checkGKs=__importStar(__webpack_require__(65748));exports.internComponent=__importStar(__webpack_require__(71660));exports.metagenServiceStatus=__importStar(__webpack_require__(30389));const FB_CONTENT_ARG_KEYS=['internal','external'];function fbContent(args){validateFbContentArgs(args);if(isInternal()){return'internal'in args?callIfFunction(args.internal):[];}else{return'external'in args?callIfFunction(args.external):[];}}exports.fbContent=fbContent;function fbInternalOnly(internalContent){return fbContent({internal:internalContent});}exports.fbInternalOnly=fbInternalOnly;function callIfFunction(arg){if(typeof arg==='function'){return arg();}return arg;}function validateFbContentArgs(args){if(typeof args!=='object'){throw new Error(`fbContent() args must be an object containing keys: ${FB_CONTENT_ARG_KEYS}. Instead got ${args}`);}const containsValidArg=Object.keys(args).find(arg=>FB_CONTENT_ARG_KEYS.find(key=>key===arg));if(!containsValidArg){throw new Error(`No valid args found in ${JSON.stringify(args)}. Accepted keys: ${FB_CONTENT_ARG_KEYS}`);}const invalidArgs=Object.keys(args).filter(arg=>!FB_CONTENT_ARG_KEYS.find(key=>key===arg));if(invalidArgs.length>0){throw new Error(`Unexpected keys ${invalidArgs} found in fbContent() args. Accepted keys: ${FB_CONTENT_ARG_KEYS}`);}}exports.validateFbContentArgs=validateFbContentArgs;function isInternal(){try{return Boolean(false);}catch(e){console.log("process.env.FB_INTERNAL couldn't be read, maybe you forgot to add the required webpack EnvironmentPlugin config?",e);return false;}}exports.isInternal=isInternal;function hasEphemeralDiffNumber(){return Boolean(getEphemeralDiffNumber());}exports.hasEphemeralDiffNumber=hasEphemeralDiffNumber;function getEphemeralDiffNumber(){try{if(false){}else{return null;}}catch(e){console.log("process.env.PHABRICATOR_DIFF_NUMBER couldn't be read, maybe you forgot to add the required webpack EnvironmentPlugin config?",e);return null;}}exports.getEphemeralDiffNumber=getEphemeralDiffNumber;function FbInternalOnly(props){if(isInternal()){return props.children;}return null;}exports.FbInternalOnly=FbInternalOnly;function OssOnly(props){if(!isInternal()){return props.children;}return null;}exports.OssOnly=OssOnly;
...
const DefaultStorageType=site_storage_namespaceObject.N;function applyNamespace(storageKey){return`${storageKey}${site_storage_namespaceObject.M}`;}function dispatchChangeEvent(_ref){let{key,oldValue,newValue,storage}=_ref;if(oldValue===newValue){return;}const event=document.createEvent('StorageEvent');event.initStorageEvent('storage',false,false,key,oldValue,newValue,window.location.href,storage);window.dispatchEvent(event);}function getBrowserStorage(storageType){if(storageType===void 0){storageType=DefaultStorageType;}if(typeof window==='undefined'){throw new Error('Browser storage is not available on Node.js/Docusaurus SSR process.');}if(storageType==='none'){return null;}try{return window[storageType];}catch(err){logOnceBrowserStorageNotAvailableWarning(err);return null;}}let hasLoggedBrowserStorageNotAvailableWarning=false;function logOnceBrowserStorageNotAvailableWarning(error){if(!hasLoggedBrowserStorageNotAvailableWarning){console.warn(`Docusaurus browser storage is not available.
Possible reasons: running Docusaurus in an iframe, in an incognito browser session, or using too strict browser privacy settings.`,error);hasLoggedBrowserStorageNotAvailableWarning=true;}}const NoopStorageSlot={get:()=>null,set:()=>{},del:()=>{},listen:()=>()=>{}};function createServerStorageSlot(key){function throwError(){throw new Error(`Illegal storage API usage for storage key "${key}".
Docusaurus storage APIs are not supposed to be called on the server-rendering process.
Please only call storage APIs in effects and event handlers.`);}return{get:throwError,set:throwError,del:throwError,listen:throwError};}function createStorageSlot(keyInput,options){const key=applyNamespace(keyInput);if(typeof window==='undefined'){return createServerStorageSlot(key);}const storage=getBrowserStorage(options?.persistence);if(storage===null){return NoopStorageSlot;}return{get:()=>{try{return storage.getItem(key);}catch(err){console.error(`Docusaurus storage error, can't get key=${key}`,err);return null;}},set:newValue=>{try{const oldValue=storage.getItem(key);storage.setItem(key,newValue);dispatchChangeEvent({key,oldValue,newValue,storage});}catch(err){console.error(`Docusaurus storage error, can't set ${key}=${newValue}`,err);}},del:()=>{try{const oldValue=storage.getItem(key);storage.removeItem(key);dispatchChangeEvent({key,oldValue,newValue:null,storage});}catch(err){console.error(`Docusaurus storage error, can't delete key=${key}`,err);}},listen:onChange=>{try{const listener=event=>{if(event.storageArea===storage&&event.key===key){onChange(event);}};window.addEventListener('storage',listener);return()=>window.removeEventListener('storage',listener);}catch(err){console.error(`Docusaurus storage error, can't listen for changes of key=${key}`,err);return()=>{};}}};}function useStorageSlot(key,options){const storageSlot=(0,react.useRef)(()=>{if(key===null){return NoopStorageSlot;}return createStorageSlot(key,options);}).current();const listen=(0,react.useCallback)(onChange=>{if(typeof window==='undefined'){return()=>{};}return storageSlot.listen(onChange);},[storageSlot]);const currentValue=(0,react.useSyncExternalStore)(listen,()=>{if(false){}return storageSlot.get();},()=>null);return[currentValue,storageSlot];}function listStorageKeys(storageType){if(storageType===void 0){storageType=DefaultStorageType;}const browserStorage=getBrowserStorage(storageType);if(!browserStorage){return[];}const keys=[];for(let i=0;i<browserStorage.length;i+=1){const key=browserStorage.key(i);if(key!==null){keys.push(key);}}return keys;}
...
function useTitleFormatter(title){const{siteConfig}=(0,useDocusaurusContext["default"])();const{title:siteTitle,titleDelimiter}=siteConfig;return title?.trim().length?`${title.trim()} ${titleDelimiter} ${siteTitle}`:siteTitle;}
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./node_modules/@docusaurus/theme-common/lib/utils/metadataUtils.js
function PageMetadata(_ref){let{title,description,keywords,image,children}=_ref;const pageTitle=useTitleFormatter(title);const{withBaseUrl}=(0,useBaseUrl.useBaseUrlUtils)();const pageImage=image?withBaseUrl(image,{absolute:true}):undefined;return/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[title&&/*#__PURE__*/(0,jsx_runtime.jsx)("title",{children:pageTitle}),title&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:title",content:pageTitle}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"description",content:description}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:description",content:description}),keywords&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"keywords",content:Array.isArray(keywords)?keywords.join(','):keywords}),pageImage&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:image",content:pageImage}),pageImage&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:image",content:pageImage}),children]});}const HtmlClassNameContext=/*#__PURE__*/react.createContext(undefined);function HtmlClassNameProvider(_ref2){let{className:classNameProp,children}=_ref2;const classNameContext=react.useContext(HtmlClassNameContext);const className=(0,clsx/* default */.A)(classNameContext,classNameProp);return/*#__PURE__*/(0,jsx_runtime.jsxs)(HtmlClassNameContext.Provider,{value:className,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Head/* default */.A,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("html",{className:className})}),children]});}function pluginNameToClassName(pluginName){return`plugin-${pluginName.replace(/docusaurus-(?:plugin|theme)-(?:content-)?/gi,'')}`;}function PluginHtmlClassNameProvider(_ref3){let{children}=_ref3;const routeContext=useRouteContext();const nameClass=pluginNameToClassName(routeContext.plugin.name);const idClass=`plugin-id-${routeContext.plugin.id}`;return/*#__PURE__*/(0,jsx_runtime.jsx)(HtmlClassNameProvider,{className:(0,clsx/* default */.A)(nameClass,idClass),children:children});}
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(o,m,k,k2){if(k2===undefined)k2=k;var desc=Object.getOwnPropertyDescriptor(m,k);if(!desc||("get"in desc?!m.__esModule:desc.writable||desc.configurable)){desc={enumerable:true,get:function(){return m[k];}};}Object.defineProperty(o,k2,desc);}:function(o,m,k,k2){if(k2===undefined)k2=k;o[k2]=m[k];});var __setModuleDefault=this&&this.__setModuleDefault||(Object.create?function(o,v){Object.defineProperty(o,"default",{enumerable:true,value:v});}:function(o,v){o["default"]=v;});var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(mod!=null)for(var k in mod)if(k!=="default"&&Object.prototype.hasOwnProperty.call(mod,k))__createBinding(result,mod,k);__setModuleDefault(result,mod);return result;};var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{"default":mod};};Object.defineProperty(exports, "__esModule", ({value:true}));const react_1=__importStar(__webpack_require__(96540));const clsx_1=__importDefault(__webpack_require__(20053));const router_1=__webpack_require__(8748);const useDocusaurusContext_1=__importDefault(__webpack_require__(40797));const useGlobalData_1=__webpack_require__(72077);const useIsBrowser_1=__importDefault(__webpack_require__(9136));const Search=props=>{const initialized=(0,react_1.useRef)(false);const searchBarRef=(0,react_1.useRef)(null);const[indexReady,setIndexReady]=(0,react_1.useState)(false);const history=(0,router_1.useHistory)();const{siteConfig={}}=(0,useDocusaurusContext_1.default)();const isBrowser=(0,useIsBrowser_1.default)();const{baseUrl}=siteConfig;const initAlgolia=(searchDocs,searchIndex,DocSearch)=>{new DocSearch({searchDocs,searchIndex,baseUrl,inputSelector:"#search_input_react",handleSelected:(_input,_event,suggestion)=>{const url=suggestion.url||"/";const a=document.createElement("a");a.href=url;history.push(url);}});};const pluginData=(0,useGlobalData_1.usePluginData)('docusaurus-lunr-search');const getSearchDoc=()=> true?fetch(`${baseUrl}${pluginData.fileNames.searchDoc}`).then(content=>content.json()):0;const getLunrIndex=()=> true?fetch(`${baseUrl}${pluginData.fileNames.lunrIndex}`).then(content=>content.json()):0;const loadAlgolia=()=>{if(!initialized.current){Promise.all([getSearchDoc(),getLunrIndex(),Promise.resolve().then(()=>__importStar(__webpack_require__(9422))),Promise.resolve().then(()=>__importStar(__webpack_require__(79534)))]).then(_ref=>{let[searchDocs,searchIndex,{default:DocSearch}]=_ref;if(searchDocs.length===0){return;}initAlgolia(searchDocs,searchIndex,DocSearch);setIndexReady(true);});initialized.current=true;}};const toggleSearchIconClick=(0,react_1.useCallback)(e=>{if(!searchBarRef.current.contains(e.target)){searchBarRef.current.focus();}props.handleSearchBarToggle&&props.handleSearchBarToggle(!props.isSearchBarExpanded);},[props.isSearchBarExpanded]);if(isBrowser){loadAlgolia();}return react_1.default.createElement("div",{className:"navbar__search",key:"search-box"},react_1.default.createElement("span",{"aria-label":"expand searchbar",role:"button",className:(0,clsx_1.default)("search-icon",{"search-icon-hidden":props.isSearchBarExpanded}),onClick:toggleSearchIconClick,onKeyDown:toggleSearchIconClick,tabIndex:0}),react_1.default.createElement("input",{id:"search_input_react",type:"search",placeholder:indexReady?'Search':'Loading...',"aria-label":"Search",className:(0,clsx_1.default)("navbar__search-input",{"search-bar-expanded":props.isSearchBarExpanded},{"search-bar":!props.isSearchBarExpanded}),onClick:loadAlgolia,onMouseOver:loadAlgolia,onFocus:toggleSearchIconClick,onBlur:toggleSearchIconClick,ref:searchBarRef,disabled:!indexReady}));};exports["default"]=Search;
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"/newLandingPage/-a69":{"__comp":"ddce6c53","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/try/-d7a":{"__comp":"dda49074","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/en/docs/-0d9":{"__comp":"5e95c892","__context":{"plugin":"aba21aa0"}},"/en/docs/-ffd":{"__comp":"a7bd4aaa","__props":"537b867c"},"/en/docs/-384":{"__comp":"a94703ab"},"/en/docs/configuration/-fe1":{"__comp":"17896441","content":"cbb899e4"},"/en/docs/import-resolution/-573":{"__comp":"17896441","content":"1b82301a"},"/en/docs/learn-python-typing/-677":{"__comp":"17896441","content":"ed255459"},"/-e5f":{"__comp":"1df93b7f","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"}}');
...
var skipToContentUtils = __webpack_require__(19585);
...
function SkipToContent(){return/*#__PURE__*/(0,jsx_runtime.jsx)(skipToContentUtils/* SkipToContentLink */.K,{className:styles_module.skipToContent});}
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/useThemeConfig.js
var useThemeConfig = __webpack_require__(53115);
...
function AnnouncementBarContent(props){const{announcementBar}=(0,useThemeConfig/* useThemeConfig */.p)();const{content}=announcementBar;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{...props,className:(0,clsx/* default */.A)(Content_styles_module.content,props.className),dangerouslySetInnerHTML:{__html:content}});}
...
function ColorModeToggle(_ref){let{className,buttonClassName,value,onChange}=_ref;const isBrowser=(0,useIsBrowser["default"])();const title=(0,Translate.translate)({message:'Switch between dark and light mode (currently {mode})',id:'theme.colorToggle.ariaLabel',description:'The ARIA label for the navbar color mode toggle'},{mode:value==='dark'?(0,Translate.translate)({message:'dark mode',id:'theme.colorToggle.ariaLabel.mode.dark',description:'The name for the dark color mode'}):(0,Translate.translate)({message:'light mode',id:'theme.colorToggle.ariaLabel.mode.light',description:'The name for the light color mode'})});return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(ColorModeToggle_styles_module.toggle,className),children:/*#__PURE__*/(0,jsx_runtime.jsxs)("button",{className:(0,clsx/* default */.A)('clean-btn',ColorModeToggle_styles_module.toggleButton,!isBrowser&&ColorModeToggle_styles_module.toggleButtonDisabled,buttonClassName),type:"button",onClick:()=>onChange(value==='dark'?'light':'dark'),disabled:!isBrowser,title:title,"aria-label":title,"aria-live":"polite","aria-pressed":value==='dark'?'true':'false',children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconLightMode,{className:(0,clsx/* default */.A)(ColorModeToggle_styles_module.toggleIcon,ColorModeToggle_styles_module.lightToggleIcon)}),/*#__PURE__*/(0,jsx_runtime.jsx)(IconDarkMode,{className:(0,clsx/* default */.A)(ColorModeToggle_styles_module.toggleIcon,ColorModeToggle_styles_module.darkToggleIcon)})]})});}/* harmony default export */ const theme_ColorModeToggle = (/*#__PURE__*/react.memo(ColorModeToggle));
...
var regexpUtils = __webpack_require__(26767);
...
function NavbarNavLink(_ref){let{activeBasePath,activeBaseRegex,to,href,label,html,isDropdownLink,prependBaseUrlToHref,...props}=_ref;const toUrl=(0,useBaseUrl["default"])(to);const activeBaseUrl=(0,useBaseUrl["default"])(activeBasePath);const normalizedHref=(0,useBaseUrl["default"])(href,{forcePrependBaseUrl:true});const isExternalLink=label&&href&&!(0,isInternalUrl/* default */.A)(href);const linkContentProps=html?{dangerouslySetInnerHTML:{__html:html}}:{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[label,isExternalLink&&/*#__PURE__*/(0,jsx_runtime.jsx)(ExternalLink/* default */.A,{...(isDropdownLink&&{width:12,height:12})})]})};if(href){return/*#__PURE__*/(0,jsx_runtime.jsx)(Link["default"],{href:prependBaseUrlToHref?normalizedHref:href,...props,...linkContentProps});}return/*#__PURE__*/(0,jsx_runtime.jsx)(Link["default"],{to:toUrl,isNavLink:true,...((activeBasePath||activeBaseRegex)&&{isActive:(_match,location)=>activeBaseRegex?(0,regexpUtils/* isRegexpStringMatch */.G)(activeBaseRegex,location.pathname):location.pathname.startsWith(activeBaseUrl)}),...props,...linkContentProps});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DefaultNavbarItem.js
function DefaultNavbarItemDesktop(_ref){let{className,isDropdownItem=false,...props}=_ref;const element=/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarNavLink,{className:(0,clsx/* default */.A)(isDropdownItem?'dropdown__link':'navbar__item navbar__link',className),isDropdownLink:isDropdownItem,...props});if(isDropdownItem){return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{children:element});}return element;}function DefaultNavbarItemMobile(_ref2){let{className,isDropdownItem,...props}=_ref2;return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:"menu__list-item",children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarNavLink,{className:(0,clsx/* default */.A)('menu__link',className),...props})});}function DefaultNavbarItem(_ref3){let{mobile=false,position,...props}=_ref3;const Comp=mobile?DefaultNavbarItemMobile:DefaultNavbarItemDesktop;return/*#__PURE__*/(0,jsx_runtime.jsx)(Comp,{...props,activeClassName:props.activeClassName??(mobile?'menu__link--active':'navbar__link--active')});}
...
function useLocalPathname(){const{siteConfig:{baseUrl}}=(0,useDocusaurusContext["default"])();const{pathname}=(0,react_router/* useLocation */.zy)();return pathname.replace(baseUrl,'/');}
...
function SearchNavbarItem(_ref){let{mobile,className}=_ref;if(mobile){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarSearch,{className:className,children:/*#__PURE__*/(0,jsx_runtime.jsx)((SearchBar_default()),{})});}
...
function DocNavbarItem(_ref){let{docId,label:staticLabel,docsPluginId,...props}=_ref;const{activeDoc}=(0,client/* useActiveDocContext */.zK)(docsPluginId);const doc=(0,docsUtils/* useLayoutDoc */.QB)(docId,docsPluginId);const pageActive=activeDoc?.path===doc?.path;if(doc===null||doc.unlisted&&!pageActive){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(DefaultNavbarItem,{exact:true,...props,isActive:()=>pageActive||!!activeDoc?.sidebar&&activeDoc.sidebar===doc.sidebar,label:staticLabel??doc.id,to:doc.path});}
...
function useNavbarItems(){return (0,useThemeConfig/* useThemeConfig */.p)().navbar.items;}function NavbarMobilePrimaryMenu(){const mobileSidebar=(0,navbarMobileSidebar/* useNavbarMobileSidebar */.M)();const items=useNavbarItems();return/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:"menu__list",children:items.map((item,i)=>/*#__PURE__*/(0,react.createElement)(NavbarItem,{mobile:true,...item,onClick:()=>mobileSidebar.toggle(),key:i}))});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Navbar/MobileSidebar/SecondaryMenu/index.js
function SecondaryMenuBackButton(props){return/*#__PURE__*/(0,jsx_runtime.jsx)("button",{...props,type:"button",className:"clean-btn navbar-sidebar__back",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Translate["default"],{id:"theme.navbar.mobileSidebarSecondaryMenu.backButtonLabel",description:"The label of the back button to return to main menu, inside the mobile navbar sidebar secondary menu (notably used to display the docs sidebar)",children:"\u2190 Back to main menu"})});}function NavbarMobileSidebarSecondaryMenu(){const isPrimaryMenuEmpty=(0,useThemeConfig/* useThemeConfig */.p)().navbar.items.length===0;const secondaryMenu=useNavbarSecondaryMenu();return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[!isPrimaryMenuEmpty&&/*#__PURE__*/(0,jsx_runtime.jsx)(SecondaryMenuBackButton,{onClick:()=>secondaryMenu.hide()}),secondaryMenu.content]});}
...
function MobileSidebarToggle(){const{toggle,shown}=(0,navbarMobileSidebar/* useNavbarMobileSidebar */.M)();return/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:toggle,"aria-label":(0,Translate.translate)({id:'theme.docs.sidebar.toggleSidebarButtonAriaLabel',message:'Toggle navigation bar',description:'The ARIA label for hamburger menu button of mobile navigation'}),"aria-expanded":shown,className:"navbar__toggle clean-btn",type:"button",children:/*#__PURE__*/(0,jsx_runtime.jsx)(IconMenu,{})});}
...
var footerUtils = __webpack_require__(63113);
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Footer/LinkItem/index.js
function FooterLinkItem(_ref){let{item}=_ref;const{to,href,label,prependBaseUrlToHref,className,...props}=item;const toUrl=(0,useBaseUrl["default"])(to);const normalizedHref=(0,useBaseUrl["default"])(href,{forcePrependBaseUrl:true});return/*#__PURE__*/(0,jsx_runtime.jsxs)(Link["default"],{className:(0,clsx/* default */.A)('footer__link-item',className),...(href?{href:prependBaseUrlToHref?normalizedHref:href}:{to:toUrl}),...props,children:[label,href&&!(0,isInternalUrl/* default */.A)(href)&&/*#__PURE__*/(0,jsx_runtime.jsx)(ExternalLink/* default */.A,{})]});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Footer/Links/MultiColumn/index.js
function ColumnLinkItem(_ref){let{item}=_ref;return item.html?/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:(0,clsx/* default */.A)('footer__item',item.className),dangerouslySetInnerHTML:{__html:item.html}}):/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:"footer__item",children:/*#__PURE__*/(0,jsx_runtime.jsx)(FooterLinkItem,{item:item})},item.href??item.to);}function Column(_ref2){let{column}=_ref2;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)('col footer__col',column.className),children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"footer__title",children:column.title}),/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:"footer__items clean-list",children:column.items.map((item,i)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ColumnLinkItem,{item:item},i))})]});}function FooterLinksMultiColumn(_ref3){let{columns}=_ref3;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"row footer__links",children:columns.map((column,i)=>/*#__PURE__*/(0,jsx_runtime.jsx)(Column,{column:column},i))});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Footer/Links/Simple/index.js
function Separator(){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:"footer__link-separator",children:"\xB7"});}function SimpleLinkItem(_ref){let{item}=_ref;return item.html?/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)('footer__link-item',item.className),dangerouslySetInnerHTML:{__html:item.html}}):/*#__PURE__*/(0,jsx_runtime.jsx)(FooterLinkItem,{item:item});}function FooterLinksSimple(_ref2){let{links}=_ref2;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"footer__links text--center",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"footer__links",children:links.map((item,i)=>/*#__PURE__*/(0,jsx_runtime.jsxs)(react.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SimpleLinkItem,{item:item}),links.length!==i+1&&/*#__PURE__*/(0,jsx_runtime.jsx)(Separator,{})]},i))})});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Footer/Links/index.js
function FooterLinks(_ref){let{links}=_ref;return (0,footerUtils/* isMultiColumnFooterLinks */.C)(links)?/*#__PURE__*/(0,jsx_runtime.jsx)(FooterLinksMultiColumn,{columns:links}):/*#__PURE__*/(0,jsx_runtime.jsx)(FooterLinksSimple,{links:links});}
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/ThemedImage/index.js
var ThemedImage = __webpack_require__(24475);
...
function LogoImage(_ref){let{logo}=_ref;const{withBaseUrl}=(0,useBaseUrl.useBaseUrlUtils)();const sources={light:withBaseUrl(logo.src),dark:withBaseUrl(logo.srcDark??logo.src)};return/*#__PURE__*/(0,jsx_runtime.jsx)(ThemedImage/* default */.A,{className:(0,clsx/* default */.A)('footer__logo',logo.className),alt:logo.alt,sources:sources,width:logo.width,height:logo.height,style:logo.style});}function FooterLogo(_ref2){let{logo}=_ref2;return logo.href?/*#__PURE__*/(0,jsx_runtime.jsx)(Link["default"],{href:logo.href,className:Logo_styles_module.footerLogoLink,target:logo.target,children:/*#__PURE__*/(0,jsx_runtime.jsx)(LogoImage,{logo:logo})}):/*#__PURE__*/(0,jsx_runtime.jsx)(LogoImage,{logo:logo});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Footer/Copyright/index.js
function FooterCopyright(_ref){let{copyright}=_ref;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"footer__copyright",dangerouslySetInnerHTML:{__html:copyright}});}
...
function ErrorPageContent(_ref){let{error,tryAgain}=_ref;return/*#__PURE__*/(0,jsx_runtime.jsx)("main",{className:"container margin-vert--xl",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"row",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"col col--6 col--offset-3",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:"h1",className:"hero__title",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Translate["default"],{id:"theme.ErrorPageContent.title",description:"The title of the fallback page when the page crashed",children:"This page crashed."})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"margin-vert--lg",children:/*#__PURE__*/(0,jsx_runtime.jsx)(errorBoundaryUtils/* ErrorBoundaryTryAgainButton */.a2,{onClick:tryAgain,className:"button button--primary shadow--lw"})}),/*#__PURE__*/(0,jsx_runtime.jsx)("hr",{}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"margin-vert--md",children:/*#__PURE__*/(0,jsx_runtime.jsx)(errorBoundaryUtils/* ErrorBoundaryError */.bq,{error:error})})]})})});}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.getApi=exports.docsets=void 0;const bridge_1=__webpack_require__(67826);exports.docsets={BLOKS_CORE:'887372105406659'};function getApi(args){const{name,framework,docset}=args;return(0,bridge_1.call)({module:'uidocs',api:'getApi',args:{name,framework,docset}});}exports.getApi=getApi;
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _docusaurus_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(61934);
const windowSizes={desktop:'desktop',mobile:'mobile',ssr:'ssr'};const DesktopBreakpoint=996;function getWindowSize(desktopBreakpoint){if(!_docusaurus_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_1__["default"].canUseDOM){throw new Error('getWindowSize() should only be called after React hydration');}return window.innerWidth>desktopBreakpoint?windowSizes.desktop:windowSizes.mobile;}function useWindowSize(_temp){let{desktopBreakpoint=DesktopBreakpoint}=_temp===void 0?{}:_temp;const[windowSize,setWindowSize]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(()=>'ssr');(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{function updateWindowSize(){setWindowSize(getWindowSize(desktopBreakpoint));}updateWindowSize();window.addEventListener('resize',updateWindowSize);return()=>{window.removeEventListener('resize',updateWindowSize);};},[desktopBreakpoint]);return windowSize;}
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));const prefix='algolia-docsearch';const suggestionPrefix=`${prefix}-suggestion`;const footerPrefix=`${prefix}-footer`;const templates={suggestion:`
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.submitDiff=exports.DiffKind=void 0;const bridge_1=__webpack_require__(67826);var DiffKind;(function(DiffKind){DiffKind["modify"]="modify";DiffKind["add"]="add";})(DiffKind||(exports.DiffKind=DiffKind={}));function submitDiff(args){const{file_path,new_content,project_name,diff_number,diff_kind}=args;return(0,bridge_1.call)({module:'inpageeditor',api:'createPhabricatorDiffApi',args:{file_path,new_content,project_name,diff_number,diff_kind}}).catch(error=>{throw new Error(`Error occurred while trying to submit diff. Stack trace: ${error}`);});}exports.submitDiff=submitDiff;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.addTrailingSlash=addTrailingSlash;exports["default"]=applyTrailingSlash;exports.addLeadingSlash=addLeadingSlash;exports.removeTrailingSlash=removeTrailingSlash;const stringUtils_1=__webpack_require__(27149);function addTrailingSlash(str){return str.endsWith('/')?str:`${str}/`;}function applyTrailingSlash(path,options){const{trailingSlash,baseUrl}=options;if(path.startsWith('#')){return path;}function handleTrailingSlash(str,trailing){return trailing?addTrailingSlash(str):removeTrailingSlash(str);}if(typeof trailingSlash==='undefined'){return path;}const[pathname]=path.split(/[#?]/);const shouldNotApply=pathname==='/'||pathname===baseUrl;const newPathname=shouldNotApply?pathname:handleTrailingSlash(pathname,trailingSlash);return path.replace(pathname,newPathname);}function addLeadingSlash(str){return(0,stringUtils_1.addPrefix)(str,'/');}function removeTrailingSlash(str){return(0,stringUtils_1.removeSuffix)(str,'/');}
...
/* harmony import */ var _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30214);
...
/******/ __webpack_require__.O(0, [1869], () => (__webpack_exec__(41823)));
