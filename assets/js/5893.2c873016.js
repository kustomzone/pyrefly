"use strict";
(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[5893],{
...
/* harmony import */ var d3_sankey__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(19818);
/* harmony import */ var d3_sankey__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(58250);
/* harmony import */ var d3_sankey__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8962);
...
const db = {
  nodesMap,
  getConfig: () => (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
let Uid = _Uid;
const alignmentsMap = {
  left: d3_sankey__WEBPACK_IMPORTED_MODULE_5__/* .left */ .kb,
  right: d3_sankey__WEBPACK_IMPORTED_MODULE_5__/* .right */ .pG,
  center: d3_sankey__WEBPACK_IMPORTED_MODULE_5__/* .center */ .gX,
  justify: d3_sankey__WEBPACK_IMPORTED_MODULE_5__/* .justify */ .pD
};
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const defaultSankeyConfig = _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.K.sankey;
  let sandboxElement;
  ...
  const svg = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)(`[id="${id}"]`);
  ...
  const nodeWidth = 10;
  const sankey$1 = (0,d3_sankey__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)().nodeId((d) => d.id).nodeWidth(nodeWidth).nodePadding(10 + (showValues ? 15 : 0)).nodeAlign(nodeAlign).extent([
    [0, 0],
    [width, height]
  ]);
  sankey$1(graph);
  const colorScheme = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleOrdinal */ .UMr)(d3__WEBPACK_IMPORTED_MODULE_0__/* .schemeTableau10 */ .zt);
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  link.append("path").attr("d", (0,d3_sankey__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)()).attr("stroke", coloring).attr("stroke-width", (d) => Math.max(1, d.width));
  (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
