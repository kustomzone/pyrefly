"use strict";
(self["webpackChunknew_website"] = self["webpackChunknew_website"] || []).push([[2343],{
...
/* harmony export */ });
/* harmony import */ var _chunk_QT24LBJ6_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8850);
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(75937);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(25582);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
    ...
    this.funs = [];
    this.setAccTitle = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getDiagramTitle */ .ab;
  ...
  static {
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(this, "FlowDB");
  }
  sanitizeText(txt) {
    return _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .common_default */ .Y2.sanitizeText(txt, this.config);
  }
  /**
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (metadata !== void 0) {
      ...
      doc = (0,_chunk_QT24LBJ6_mjs__WEBPACK_IMPORTED_MODULE_0__/* .load */ .H)(yamlData, { schema: _chunk_QT24LBJ6_mjs__WEBPACK_IMPORTED_MODULE_0__/* .JSON_SCHEMA */ .r });
    }
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_JXS2JFWQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .isValidShape */ .aP)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.info("abc78 Got edge...", edge);
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getEdgeId */ .rY)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getEdgeId */ .rY)(edge.start, edge.end, {
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.info("Pushing edge...");
...
You have to call mermaid.initialize.`
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.info("addLink", _start, _end, id);
  ...
  setClickFun(id, functionName, functionArgs) {
    ...
    if ((0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ ._K.formatUrl(linkStr, this.config);
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .clear */ .IU)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const uniq = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)((a) => {
    ...
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  getData() {
    const config = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getEdgeId */ .rY)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .defaultConfig2 */ .ME.flowchart;
  }
};

// src/diagrams/flowchart/flowRenderer-v3-unified.ts

var getClasses = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.info("REF0:");
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.info("Drawing state diagram (v2)", id);
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
  let sandboxElement;
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_11__/* .select */ .Ltv)("#i" + id);
  }
  const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.debug("Data: ", data4Layout);
  const svg = (0,_chunk_2O5F6CEG_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getDiagramElement */ .A)(id, securityLevel);
  const direction = diag.db.getDirection();
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_SSJB2B2L_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
    _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.warn(
  ...
  _chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .Rm.debug("REF1:", data4Layout);
  await (0,_chunk_SSJB2B2L_mjs__WEBPACK_IMPORTED_MODULE_2__/* .render */ .XX)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_ABD7OU7K_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ ._K.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_2O5F6CEG_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "flowchart", conf?.useMaxWidth || false);
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function parse(input) {
      ...
      (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)(Parser, "Parser");
...
var fade = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)((color, opacity) => {
...
var getStyles = /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)((options) => `.label {
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K2)((cnf) => {
    ...
    if (cnf.layout) {
      (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setConfig2 */ .XV)({ layout: cnf.layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_O7R7247Q_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setConfig2 */ .XV)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
};
